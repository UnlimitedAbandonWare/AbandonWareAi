 ...
 * Module: com.nova.protocol.filter.RuleBreakInterceptor
 * Role: config
 * Dependencies: com.nova.protocol.config.NovaProperties, com.nova.protocol.context.RuleBreakContext, com.nova.protocol.rulebreak.RuleBreakPolicy, +1 more
 * Observability: propagates trace headers if present.
 * Thread-Safety: appears stateless.
 */
/* agent-hint:
id: com.nova.protocol.filter.RuleBreakInterceptor
role: config
*/
