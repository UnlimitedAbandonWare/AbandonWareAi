 ...
 * 클래스: PlanContext
 * 역할(Role): Class
 * 소스 경로: app/src/main/java/com/nova/protocol/context/PlanContext.java
 *
 * 연결 포인트(Hooks):
...
// Module: com.nova.protocol.context.PlanContext
// Role: config
// Dependencies: com.nova.protocol.plan.Plan
// Observability: propagates trace headers if present.
// Thread-Safety: appears stateless.
// /
/* agent-hint:
id: com.nova.protocol.context.PlanContext
role: config
*/
class PlanContext {
