 ...
 * 클래스: BraveContext
 * 역할(Role): Class
 * 소스 경로: app/src/main/java/com/nova/protocol/context/BraveContext.java
 *
 * 연결 포인트(Hooks):
...
// Module: com.nova.protocol.context.BraveContext
// Role: config
// Observability: propagates trace headers if present.
// Thread-Safety: appears stateless.
// /
/* agent-hint:
id: com.nova.protocol.context.BraveContext
role: config
*/
class BraveContext {
