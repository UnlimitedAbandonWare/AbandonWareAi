...
/** Soft clamp to avoid hypersensitivity / hyposensitivity. */
/**
 * [GPT-PRO-AGENT] 파일 수준 주석 - 기능 연결을 돕기 위한 설명
 * 클래스: BodeSensitivityClamp
 * 역할(Role): Class
 * 관련 기능(Tags): RAG Fusion
 * 소스 경로: app/src/main/java/com/abandonware/ai/service/rag/fusion/BodeSensitivityClamp.java
 *
 * 연결 포인트(Hooks):
...
// Module: com.abandonware.ai.service.rag.fusion.BodeSensitivityClamp
// Role: config
// Observability: propagates trace headers if present.
// Thread-Safety: appears stateless.
// /
/* agent-hint:
id: com.abandonware.ai.service.rag.fusion.BodeSensitivityClamp
role: config
*/
class BodeSensitivityClamp {
    public static double clamp(double x){
        return Math.tanh(x); // [-1,1] soft clamp
    }
}