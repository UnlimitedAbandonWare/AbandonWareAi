...
/** Time budget guard placeholder (cooperates with CancelToken). */
/**
 * [GPT-PRO-AGENT] 파일 수준 주석 - 기능 연결을 돕기 위한 설명
 * 클래스: TimeBudgetGuard
 * 역할(Role): Class
 * 소스 경로: app/src/main/java/com/abandonware/ai/zsystem/TimeBudgetGuard.java
 *
 * 연결 포인트(Hooks):
...
// Module: com.abandonware.ai.zsystem.TimeBudgetGuard
// Role: config
// Observability: propagates trace headers if present.
// Thread-Safety: appears stateless.
// /
/* agent-hint:
id: com.abandonware.ai.zsystem.TimeBudgetGuard
role: config
*/
class TimeBudgetGuard {
    public static boolean within(long startedAtMillis, long budgetMs){
        return (System.currentTimeMillis() - startedAtMillis) < budgetMs;
    }
}