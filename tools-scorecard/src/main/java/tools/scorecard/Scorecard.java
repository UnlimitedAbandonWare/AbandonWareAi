...
/** Minimal scorecard stub to allow build in this patch stage. */
/**
 * [GPT-PRO-AGENT] 파일 수준 주석 - 기능 연결을 돕기 위한 설명
 * 클래스: Scorecard
 * 역할(Role): Class
 * 소스 경로: tools-scorecard/src/main/java/tools/scorecard/Scorecard.java
 *
 * 연결 포인트(Hooks):
...
*/
class Scorecard {
    public static int score() { return 100; }
