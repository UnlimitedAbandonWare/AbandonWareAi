...
| File                                      | Description                                                   |
|-------------------------------------------|---------------------------------------------------------------|
| `your-cross-encoder.onnx`                 | Placeholder path only unless an external model larger than 1 MB is supplied. Runtime disables smaller files as `placeholder_or_too_small_model`. |
