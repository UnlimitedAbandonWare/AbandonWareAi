...
public class NaverInterruptHygieneAspect {
    ...
    public Object aroundSearchWithTraceSync(ProceedingJoinPoint pjp) throws Throwable {
        if (Thread.currentThread().isInterrupted()) {
            ...
            try {
                ...
                traceSuppressed("entry.searchWithTraceSync");
            }
        ...
        try {
            ...
            traceSuppressed("caught.searchWithTraceSync");
            ...
            if (kind != null) {
                ...
                try {
                    ...
                    TraceStore.put("naver.interruptHygiene.swallowed.error", kind.name().toLowerCase(Locale.ROOT));
                    TraceStore.put("naver.interruptHygiene.swallowed.kind", kind.name());
                } catch (Exception ignore) {
                    traceSuppressed("swallowed.searchWithTraceSync");
                }
                log.debug("[nova][interrupt-hygiene] swallowed {} searchWithTraceSync(): errorHash={} errorLength={}",
                        kind.name(),
    ...
    public Object aroundSearchSnippetsSync(ProceedingJoinPoint pjp) throws Throwable {
        if (Thread.currentThread().isInterrupted()) {
            ...
            try {
                ...
                traceSuppressed("entry.searchSnippetsSync");
            }
        ...
        try {
            ...
            traceSuppressed("caught.searchSnippetsSync");
            HygieneKind kind = classify(t);
            if (kind != null) {
                if (kind == HygieneKind.INTERRUPTED || Thread.currentThread().isInterrupted()) {
                    Thread.interrupted();
                ...
                try {
                    ...
                    traceSuppressed("swallowed.searchSnippetsSync");
                }
                log.debug("[nova][interrupt-hygiene] swallowed {} searchSnippetsSync(): errorHash={} errorLength={}",
                        kind.name(),
                        SafeRedactor.hashValue(messageOf(t)), messageLength(t));
                return Collections.emptyList();
            }
    ...
    private static boolean looksTimeout(Throwable t) {
        ...
        try {
            ...
            traceSuppressed("timeout.suppressed.scan");
        }
    ...
    private static boolean looksCancelled(Throwable t) {
        ...
        try {
            ...
            traceSuppressed("cancel.stack.scan");
        }
        ...
        try {
            ...
            traceSuppressed("cancel.suppressed.scan");
        }
    ...
    private static void traceSuppressed(String stage) {
        log.debug("[nova][interrupt-hygiene] suppressed stage={}",
