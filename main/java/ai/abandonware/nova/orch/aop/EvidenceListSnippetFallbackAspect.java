...
public class EvidenceListSnippetFallbackAspect {
    ...
    private static final Logger log = LoggerFactory.getLogger(EvidenceListSnippetFallbackAspect.class);
    ...
    public Object aroundDegradeToEvidenceList(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            TraceStore.put("guard.degradedToEvidence.snippetFallback.degrade.changed", changed);
        } catch (Throwable ignore) {
            traceSuppressed("degrade.counts");
        }
    ...
    public Object aroundEnsureCoverage(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            if (args != null && args.length >= 5) {
                ...
                if (rawTopDocs instanceof List<?> rawList) {
                    ...
                    if (supported) {
                        ...
                        List<EvidenceAwareGuard.EvidenceDoc> topDocs =
                                (List<EvidenceAwareGuard.EvidenceDoc>) (List<?>) rawList;
                        ...
                        try {
                            ...
                            traceSuppressed("ensureCoverage.counts");
                        }

                        if (counts.changed) {
                            proceedArgs = args.clone();
                            proceedArgs[1] = out;
                        }
                    }
                }
            ...
            try {
                ...
                traceSuppressed("ensureCoverage.error");
            }
        }
        return proceedArgs == null ? pjp.proceed() : pjp.proceed(proceedArgs);
    }
    ...
    public Object aroundEvidenceAnswerComposer(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
                ...
                if (rawEvidence instanceof List<?> rawList) {
                    ...
                    if (supported) {
                        ...
                        try {
                            TraceStore.put("guard.degradedToEvidence.titleFallback.count", counts.titleFallback);
                            TraceStore.put("guard.degradedToEvidence.snippetFallback.count", counts.snippetFallback);
                            TraceStore.put("guard.degradedToEvidence.snippetFallback.evidenceAnswerComposer.changed", counts.changed);
                        } catch (Throwable ignore) {
                            traceSuppressed("composer.counts");
                        }
            ...
            try {
                ...
                traceSuppressed("composer.error");
            }
        }
        return proceedArgs == null ? pjp.proceed() : pjp.proceed(proceedArgs);
    }
    ...
    private static String safeHost(String url) {
        ...
        try {
            ...
            traceSuppressed("url.host", ignore);
            return "";
        }
    }
        ...
        try {
            ...
            for (int i = parts.length - 1; i >= 0; i--) {
                ...
                try {
                    ...
                    traceSuppressed("urlDecode.pathTail");
                }
            ...
            traceSuppressed("url.pathTail", ignore);
            return "";
        }
    }
    ...
    private static void traceSuppressed(String stage, Throwable error) {
        log.debug("[nova][evidence-list-snippet-fallback] suppressed stage={} errorHash={} errorLength={}",
