...
public class NaverDomainProfileHatchAspect {
    ...
    public Object around(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("naverDomainProfileHatch.guardContext", ignore);
            ctx = null;
        }
        ...
        try {
            ...
            if (touched) {
                try {
                    ...
                    TraceStore.put("naver.domainProfile.hatch.restoreSkipped", true);
                    TraceStore.put("naver.domainProfile.hatch.restoreReason", "guard_context_restore_failed");
                }
            }
        }
    }
