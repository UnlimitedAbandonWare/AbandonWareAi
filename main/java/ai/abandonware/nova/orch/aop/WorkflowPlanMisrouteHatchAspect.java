        ...
        if (hasOfficialToken && !hasOtherLegalCue) {
            ...
            if (ctx != null) {
                try {
                    ...
                    TraceStore.put("plan.hatch.ap1Misroute.contextUpdateSkipped", true);
                    TraceStore.put("plan.hatch.ap1Misroute.contextUpdateReason", "guard_context_plan_update_failed");
                }
            }
            ...
            TraceStore.put("plan.hatch.ap1Misroute.queryHash", SafeRedactor.hashValue(q));
            TraceStore.put("plan.hatch.ap1Misroute.queryLength", q.length());
