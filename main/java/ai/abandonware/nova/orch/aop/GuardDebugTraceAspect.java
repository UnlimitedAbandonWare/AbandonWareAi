...
public class GuardDebugTraceAspect {
    ...
    private Object traceStage(String stage, ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            traceSuppressed("snapshot.before", ignore);
        }
        ...
        try {
            ...
            try {
                ...
                traceSuppressed("snapshot.after", ignore);
            }
    ...
    private static void traceSuppressed(String stage, Throwable t) {
        log.debug("[nova][guard-debug-trace] suppressed stage={} errorHash={} errorLength={}",
    ...
    private static String extractQuery(Object[] args) {
        ...
        Object a0 = args[0];
        if (a0 instanceof ChatRequestDto dto && dto.getMessage() != null) {
    ...
    private static final class GuardSnapshot {
        ...
        static GuardSnapshot capture(String stage, String phase, String query, GuardContext ctx, NightmareBreaker nb) {
            ...
            if (auxDownLast == null || auxDownLast.isBlank()) auxDownLast = null;

            String auxBlockedLast = SafeRedactor.traceLabelOrFallback(TraceStore.get("aux.blocked.last"), "");
            if (auxBlockedLast == null || auxBlockedLast.isBlank()) auxBlockedLast = null;
        ...
        Map<String, Object> asMap() {
            try {
                ...
                m.put("stage", stage);
                m.put("phase", phase);
                m.put("queryHash", SafeRedactor.hashValue(queryClip));
                m.put("queryLength", queryClip == null ? 0 : queryClip.length());
                ...
                traceSuppressed("snapshot.asMap", t);
        ...
        String prettyLine(Throwable err) {
            ...
            sb.append(" reason=").append(SafeRedactor.traceLabelOrFallback(orchReason, "unknown"));
            ...
            if (queryClip != null && !queryClip.isBlank()) {
                sb.append(" queryHash=").append(SafeRedactor.hashValue(queryClip))
                        .append(" queryLength=").append(queryClip.length());
            }

            if (err != null) {
                sb.append(" err=").append(err.getClass().getSimpleName()).append(":")
                        .append(SafeRedactor.safeMessage(err.getMessage(), 120));
            }
