...
public class WebFailSoftSearchAspect {
    ...
    // Optional (debug/soak): in-memory last KPI snapshot for /internal/probe/websoak-kpi/last
    @Nullable
    @org.springframework.beans.factory.annotation.Autowired(required = false)
    private WebSoakKpiLastStore webSoakKpiLastStore;
    ...
    /** Optional recirculation buffer; absent in minimal/test slices. */
    @Nullable
    @org.springframework.beans.factory.annotation.Autowired(required = false)
    ...
    public Object aroundSearch(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            try {
                TraceStore.put("web.failsoft.guardContext.failed", true);
                TraceStore.put("web.failsoft.guardContext.stage", "GuardContextHolder.get");
                TraceStore.put("web.failsoft.guardContext.errorType",
                        SafeRedactor.traceLabelOrFallback(
                                t.getClass().getSimpleName(),
                                "unknown"));
            } catch (Throwable ignore) {
                WebFailSoftTraceSuppressions.trace("guardContext.failureTrace", ignore);
            }
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("webFailSoft.summarizeAwaitEvents", ignore);
        }

        List<String> raw;
        try {
            raw = castList(pjp.proceed(new Object[] { canonical, topK }));
        } catch (RuntimeException e) {
            WebFailSoftFailureTrace.recordInitialHybridFailure("search", e, canonical);
        ...
        try {
            ...
            if (aug != null && aug.queries() != null) {
                ...
                WebFailSoftRescueQuerySorter.sortOfficialDocsRescueQueries(qCandidates, ctx,
                        "web.failsoft.minCitationsRescue.sort");
            }
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("minCitationsRescue.preflightTrace", ignore);
            }
            ...
            if (eligible) {
                ...
                try {
                    ...
                    TraceStore.put("web.failsoft.minCitationsRescue.candidates", SafeRedactor.diagnosticValue("web.failsoft.minCitationsRescue.queryCandidates", capList(new ArrayList<>(qCandidates), 5)));
                } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("minCitationsRescue.traceStart", ignore); }
                ...
                for (String q2 : qCandidates) {
                    ...
                    if (rescueSnippets.size() >= deficit)
                        break;
                    try {
                        TraceStore.put("web.failsoft.minCitationsRescue.rescueQuery", SafeRedactor.diagnosticValue("web.failsoft.minCitationsRescue.rescueQuery", q2, 240));
                        callsIssued++;
                        ...
                        WebFailSoftTraceSuppressions.trace("minCitationsRescue.queryAttempt", ignoreOne);
                    }
                }
                ...
                } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("minCitationsRescue.blockReason", ignore); }
                ...
                try {
                    ...
                    WebFailSoftTraceSuppressions.trace("minCitationsRescue.debugEvent", ignoreOne);
                }
            }
        } catch (Exception ignore) {
            WebFailSoftTraceSuppressions.trace("minCitationsRescue.outer", ignore);
        }
        ...
        try {
            ...
            if (Boolean.TRUE.equals(needRescue)
                ...
                try {
                    ...
                    TraceStore.put("web.failsoft.starvationFallback.qualityGate.rescueExtraSearch.candidates", SafeRedactor.diagnosticValue("web.failsoft.starvationFallback.qualityGate.rescueExtraSearch.queryCandidates", capList(new ArrayList<>(qCandidates), 5)));
                    TraceStore.put("web.failsoft.starvationFallback.qualityGate.rescueExtraSearch.budget", callBudget);
                } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("qualityGate.rescueTraceStart", ignore); }
                ...
                for (String q2 : qCandidates) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            ev.put("executedQuery", SafeRedactor.diagnosticValue("web.failsoft.starvationFallback.qualityGate.executedQuery", canonical, 240));
                            ev.put("rescueQuery", SafeRedactor.diagnosticValue("web.failsoft.starvationFallback.qualityGate.rescueQuery", q2, 240));
                            ...
                            WebFailSoftTraceSuppressions.trace("qualityGate.rescueAttemptTrace", ignore);
                        }
                        if (rescueSnippet != null && !rescueSnippet.isBlank()) {
                            ...
                            TraceStore.put("web.failsoft.starvationFallback.qualityGate.rescueExtraQuery", SafeRedactor.diagnosticValue("web.failsoft.starvationFallback.qualityGate.rescueExtraQuery", q2, 240));
                            ...
                            if (debugEventStore != null) {
                                ...
                                data.put("executedQuery", SafeRedactor.diagnosticValue("web.failsoft.starvationFallback.qualityGate.executedQuery", canonical, 240));
                                data.put("rescueQuery", SafeRedactor.diagnosticValue("web.failsoft.starvationFallback.qualityGate.rescueQuery", q2, 240));
                        ...
                        log.debug("[nova][web-failsoft] qualityGate rescue search failed failureReason={} errorType={}",
            ...
            WebFailSoftTraceSuppressions.trace("qualityGate.outer", ignore);
        }
        ...
        if ((staged == null || staged.isEmpty())
            ...
            for (String q2 : aug.queries()) {
                ...
                try {
                    ...
                    if (staged2 != null && !staged2.isEmpty()) {
                        TraceStore.put("web.failsoft.extraQuery", SafeRedactor.diagnosticValue("web.failsoft.extraQuery", q2, 240));
                        return staged2;
                    }
                } catch (Exception e) {
                    WebFailSoftFailureTrace.record("web.failsoft.extraSearch", e, q2);
                    log.debug("[nova][web-failsoft] extra search failed failureReason={} errorType={}",
                            NightmareBreaker.classify(e),
                            SafeRedactor.traceLabelOrFallback(e.getClass().getSimpleName(), "unknown"));
                }
            }
    ...
    public Object aroundSearchWithTrace(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            if (faultMaskingLayerMonitor != null) {
                ...
                log.warn("[WebFailSoftSearchAspect] GuardContextHolder missing (searchWithTrace) failureReason={} errorType={}",
                        NightmareBreaker.classify(t),
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("searchWithTrace.preflightBraveBackoff", ignore);
        }

        Object obj;
        try {
            obj = pjp.proceed(new Object[] { canonical, topK });
        } catch (RuntimeException e) {
            WebFailSoftFailureTrace.recordInitialHybridFailure("searchWithTrace", e, canonical);
            summarizeAwaitEventsForTrace();
            maybeApplyProviderBackoffFromAwaitSummary();
        ...
        if (res.trace() != null) {
            ...
            } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("searchResult.traceMeta", ignore); }
        }
        summarizeAwaitEventsForTrace();
        maybeApplyProviderBackoffFromAwaitSummary();
    ...
    private List<String> applyStages(List<String> raw,
        ...
        try {
            ...
            if (!executedQuerySafe.isBlank()) {
                TraceStore.put("web.failsoft.executedQueryHash", SafeRedactor.hashValue(executedQuerySafe));
                TraceStore.put("web.failsoft.executedQueryLength", executedQuerySafe.length());
            }
            ...
            WebFailSoftTraceSuppressions.trace("applyStages.runInitTrace", ignore);
        }
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("applyStages.minCitationsRead", ignore);
            minCitations = 0;
        }
        ...
        if ("GENERAL".equalsIgnoreCase(whitelistProfile)) {
            ...
            } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("domainProfile.hatchTrace", ignore); }
        }
        try {
            TraceStore.put("web.failsoft.highRisk", highRisk);
            TraceStore.put("web.failsoft.minCitationsDefaultUsed", minCitationsDefaultUsed);
        } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("run.highRiskTrace", ignore); }
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("officialOnlyClamp.includeDevCommunityTrace", ignore);
        }
        ...
        for (String s : raw) {
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("applyStages.classifyDetailed", ignore);
            ...
            if (key != null && !key.isBlank()) {
                cand.put("key", SafeRedactor.diagnosticValue("web.failsoft.candidate.key", key, 280));
            }
            cand.put("url", SafeRedactor.diagnosticValue("web.failsoft.candidate.url", sn == null ? null : sn.url(), 260));
            ...
            cand.put("tokenHits", SafeRedactor.diagnosticValue("web.failsoft.candidate.rawText.positiveHits", capList(tokenHits, 12), 120));
            cand.put("tokenHitDetails", buildHitDetails(sn, tokenHits, 6, 36));
            cand.put("negHitCount", negHits.size());
            cand.put("negHits", SafeRedactor.diagnosticValue("web.failsoft.candidate.rawText.negativeHits", capList(negHits, 12), 120));
                ...
                try {
                    domainStageReport.record(
                            stageEvent(runId, executedQuerySafe, canonicalQuery, aug.intent().name(), sn, usedDecision,
                                    false, cand));
                } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("domainStageReport.raw", ignore); }
            }
        }
        ...
        for (WebFailSoftStage stage : order) {
            ...
            if (officialOnly
                ...
                try {
                    ...
                    WebFailSoftTraceSuppressions.trace("profileBoost.deferredTrace", ignore);
                }
                continue;
            }
            ...
            for (TaggedSnippet ts : list) {
                ...
                // DROP: DEV_COMMUNITY + UNVERIFIED selection often indicates a strict/misrouted profile.
                if (stage == WebFailSoftStage.DEV_COMMUNITY && cred == RerankSourceCredibility.UNVERIFIED) {
                    try {
                        ...
                        if (prev == null) {
                            ...
                            TraceStore.put("web.failsoft.domainMisroute.queryLength", executedQuerySafe == null ? 0 : executedQuerySafe.length());
                        }
                    } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("domainMisroute.trace", ignore); }
                    if (faultMaskingLayerMonitor != null) {
                        try {
                        ...
                        } catch (Throwable ignore) { WebFailSoftTraceSuppressions.trace("domainMisroute.faultMask", ignore); }
                    }
                    ...
                    try {
                        domainStageReport
                                .record(stageEvent(runId, executedQuerySafe, canonicalQuery, aug.intent().name(), sn, d,
                                        true, cand));
                    } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("domainStageReport.selected", ignore); }
                }
        ...
        if (officialOnly && citeableTarget > 0 && citeableCount < citeableTarget) {
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("citeableTopUp.insertMode", ignore);
            }
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("citeableTopUp.insertTrace", ignore);
            }
            ...
            if (citeableTopUpAdded > 0) {
                try {
                    ...
                    WebFailSoftTraceSuppressions.trace("citeableTopUp.summaryTrace", ignore);
                }
            } else {
                try {
                    ...
                    WebFailSoftTraceSuppressions.trace("citeableTopUp.unusedTrace", ignore);
                }
            }
        }
        ...
        try {
            ...
            TraceStore.put("starvationFallback.poolUsed", fallbackStage.name());
            TraceStore.put("web.failsoft.starvationFallback.pool.safe.size", safe == null ? 0 : safe.size());
            TraceStore.put("starvationFallback.pool.safe.size", safe == null ? 0 : safe.size());
            TraceStore.put("web.failsoft.starvationFallback.pool.dev.size", devRescue == null ? 0 : devRescue.size());
            TraceStore.put("starvationFallback.pool.dev.size", devRescue == null ? 0 : devRescue.size());
            TraceStore.put("web.failsoft.starvationFallback.pool.size", fallbackPool == null ? 0 : fallbackPool.size());
        } catch (Exception ignore) {
            WebFailSoftTraceSuppressions.trace("starvationFallback.poolTrace", ignore);
        }
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("starvationFallback.citeableTargetTrace", ignore);
        }
        ...
        if (shouldStarvationFallback(officialOnly, highRisk, aug, out, minCitations, topK, fallbackPool,
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("starvationFallback.baseTrace", ignore);
            }
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("starvationFallback.capTrace", ignore);
            }
            ...
            if (severeTopUp) {
                ...
                try {
                    ...
                    WebFailSoftTraceSuppressions.trace("starvationFallback.severeTopUpTrace", ignore);
                }
            }
            ...
            if ("BELOW_MIN_CITATIONS".equals(trigger)) {
                if (severeTopUp) {
                    ...
                    try {
                        ...
                        WebFailSoftTraceSuppressions.trace("starvationFallback.severeDesiredTrace", ignore);
                    }
                } else {
                    ...
                    try {
                        ...
                        WebFailSoftTraceSuppressions.trace("starvationFallback.citeableDesiredTrace", ignore);
                    }
                }
            } else {
                desiredOutSize = maxOutSize;
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("starvationFallback.addLimitTrace", ignore);
            }
            int added = 0;
                ...
                if (domainStageReport != null) {
                    try {
                        domainStageReport
                                .record(stageEvent(runId, executedQuerySafe, canonicalQuery, aug.intent().name(), sn, d,
                                        true, cand));
                    } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("domainStageReport.supplementalSelected", ignore); }
                }
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("starvationFallback.citeableAfterTrace", ignore);
            }
            try {
                ...
                if (prevLog == null) {
                    ...
                    log.warn(
                            "[nova][web-failsoft] starvationFallback branch (runId={}, trigger={}, officialOnly={}, outBefore={}, added={}, outAfter={}, desiredOutSize={}, addLimit={}, minCitations={}, topK={}, auxDegraded={}, auxHardDown={}, queryHash={}, queryLength={})",
                            runId,
                            trigger,
                            officialOnly,
                            outBefore,
                            ...
                            auxDegraded,
                            auxHardDown,
                            SafeRedactor.hashValue(executedQuerySafe),
                            executedQuerySafe == null ? 0 : executedQuerySafe.length());
                }
            } catch (Throwable ignore) {
                WebFailSoftTraceSuppressions.trace("starvationFallback.branchLog", ignore);
            }
            ...
            TraceStore.put("starvationFallback.count", String.valueOf(added));
            ...
            if (added > 0) {
                ...
                } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("starvationFallback.thinRescueTrace", ignore); }
                ...
                if (faultMaskingLayerMonitor != null && severeStarvation) {
                    ...
                    } catch (Throwable ignore) { WebFailSoftTraceSuppressions.trace("starvationFallback.faultMask", ignore); }
                }
            } else {
                ...
                try {
                    ...
                    TraceStore.put("starvationFallback.used", false);
                } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("starvationFallback.usedFalseTrace", ignore); }
            }
        }
            ...
            if (profileBoost != null && !profileBoost.isEmpty()) {
                ...
                if (!allowFill) {
                    ...
                    try {
                        ...
                        WebFailSoftTraceSuppressions.trace("profileBoost.deferredAfterFallbackTrace", ignore);
                    }
                } else {
                    int filled = 0;
                    ...
                    try {
                        ...
                        WebFailSoftTraceSuppressions.trace("profileBoost.filledTrace", ignore);
                    }
                }
            }
        }
        ...
        if (officialOnly && out.isEmpty() && raw != null && !raw.isEmpty() && nightmareBreaker != null) {
            try {
                ...
                if (prevLog == null) {
                    ...
                    boolean auxHardDown = (ctx != null && ctx.isAuxHardDown());
                    log.warn(
                            "[nova][web-failsoft] officialOnly starved (runId={}, rawCount={}, outCount=0, auxDegraded={}, auxHardDown={}, queryHash={}, queryLength={})",
                            runId,
                            raw == null ? 0 : raw.size(),
                            auxDegraded,
                            auxHardDown,
                ...
                WebFailSoftTraceSuppressions.trace("officialOnlyStarved.log", ignore);
            }
        ...
        try {
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("candidateDiagnostics.fallbackEligibility", ignore);
            ...
            WebFailSoftTraceSuppressions.trace("candidateDiagnostics.finalize", ignore);
        }
        ...
        try {
            if (officialOnly) {
                ...
                try {
                    ...
                    WebFailSoftTraceSuppressions.trace("officialOnlyClamp.fallbackProps", ignore2);
                }
            ...
            WebFailSoftTraceSuppressions.trace("officialOnlyClamp.evidenceTrace", ignore);
        }

        // FAIL-SOFT QUALITY GATE: when officialOnly fallback selects mostly
        // UNVERIFIED sources, force-in one OFFICIAL/DOCS candidate when available and
        // preserve TraceStore/DebugEvent breadcrumbs for merge-boundary RCA.
        ...
        try {
                    ...
                    if (forced != null) {
                        ...
                        if (k != null && !k.isBlank() && !seenKeys.contains(k)) {
                            ...
                            if (out.size() >= targetCount) {
                                    ...
                                    if (removed != null) {
                                        ...
                                        if (rr.startsWith("[WEB:")) {
                                            ...
                                            if (rSep > 5) {
                                                ...
                                                } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("forceOfficial.removedStageParse", ignore); }
                                ...
                                } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("forceOfficial.selectedCountsAdjust", ignore); }
                            }
            ...
            } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("qualityGate.errorTrace", ignore); }
        }
        ...
        if (qgTriggered) {
            ...
            } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("qualityGate.summaryTrace", ignore); }

            if (debugEventStore != null) {
                Map<String, Object> data = new LinkedHashMap<>();
                data.put("note", "officialOnly starvationFallback quality gate");
                data.put("runId", runId);
                data.put("executedQuery", SafeRedactor.diagnosticValue("web.failsoft.starvationFallback.qualityGate.executedQuery", executedQuerySafe, 240));
                data.put("canonicalQuery", SafeRedactor.diagnosticValue("web.failsoft.starvationFallback.qualityGate.canonicalQuery", canonicalQuery, 240));
                ...
                try {
                    ...
                    try {
                        TraceStore.inc("web.failsoft.debugEvent.emit.failed");
                        TraceStore.put("web.failsoft.debugEvent.emit.failureClass",
                                "web_failsoft_debug_event_emit_failed");
                    } catch (RuntimeException ignore) {
                        WebFailSoftTraceSuppressions.trace("debugEvent.emitFailureTrace", ignore);
                    }
                }
            }
        }
        ...
        if ((out == null || out.isEmpty()) && rawInputNonBlankCount > 0) {
                    ...
                    if (cand != null) {
                        ...
                        if (sc instanceof Number n) {
                            ...
                            try {
                                ...
                                WebFailSoftTraceSuppressions.trace("demotionLadder.scoreParse", ignore);
                                score = 0;
                            }
                        }
                    }
            ...
            if (used && usedSnippet != null && usedStage != null && usedSnippet.sn != null) {
                ...
                if (domainStageReport != null) {
                    try {
                        ...
                        domainStageReport.record(stageEvent(runId, executedQuerySafe, canonicalQuery,
                                intentName, sn, d, true, usedCand));
                    } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("domainStageReport.finalSelected", ignore); }
                }
                ...
                try {
                    ...
                    if (usedKey != null && !usedKey.isBlank()) {
                        TraceStore.put("web.failsoft.demotionLadder.key", SafeRedactor.diagnosticValue("web.failsoft.demotionLadder.key", usedKey, 260));
                    }
                    if (!executedQuerySafe.isBlank()) {
                        TraceStore.put("web.failsoft.demotionLadder.executedQuery", SafeRedactor.diagnosticValue("web.failsoft.demotionLadder.executedQuery", executedQuerySafe, 240));
                    }
                    if (!canonicalQuery.isBlank()) {
                        TraceStore.put("web.failsoft.demotionLadder.canonicalQuery", SafeRedactor.diagnosticValue("web.failsoft.demotionLadder.canonicalQuery", canonicalQuery, 240));
                    }
                } catch (Exception ignore) {
                    WebFailSoftTraceSuppressions.trace("demotionLadder.usedTrace", ignore);
                }
                ...
                try {
                    ...
                    ev.put("host", host);
                    ev.put("key", SafeRedactor.diagnosticValue("web.failsoft.demotionLadder.key", usedKey, 260));
                    ...
                    WebFailSoftTraceSuppressions.trace("demotionLadder.eventTrace", ignore);
                }
            } else {
                ...
                try {
                    ...
                    WebFailSoftTraceSuppressions.trace("demotionLadder.noCandidateTrace", ignore);
                }
            }
        }

        EcosystemBufferPool poolForRecirculation = ecosystemBufferPool;
        if (out.isEmpty() && poolForRecirculation != null) {
            int maxItems = Math.max(1,
                    Math.min(Math.max(1, targetCount), poolForRecirculation.defaultRecirculateMax()));
            EcosystemBufferPool.Recirculation scan = poolForRecirculation.recirculateSafe(maxItems, snippet -> {
                String url = snippet == null || snippet.url() == null ? "" : snippet.url();
                String lower = url.isBlank() && snippet != null && snippet.lower() != null ? snippet.lower() : url;
                return HybridWebSearchProvider.isLowTrustUrl(lower);
            });
            poolForRecirculation.recordRecirculationScan(scan);
            int added = 0;
            if (scan != null && !scan.safe().isEmpty()) {
                for (WebSnippet snippet : scan.safe()) {
                    String key = keyFor(snippet);
                    if (key == null || key.isBlank() || seenKeys.contains(key)) {
                        continue;
                    }
                    seenKeys.add(key);
                    if (snippet.host() != null && !snippet.host().isBlank()) {
                        seenHosts.add(snippet.host().toLowerCase(Locale.ROOT));
                    }
                    out.add(formatSnippet(snippet.raw(), WebFailSoftStage.NOFILTER_SAFE,
                            RerankSourceCredibility.UNVERIFIED, tagSnippetBody));
            ...
            poolForRecirculation.recordRecirculationSelection(added);
        }
        ...
        } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("finalStats.trace", ignore); }

        TraceStore.put("web.failsoft.canonicalQuery", SafeRedactor.diagnosticValue("web.failsoft.canonicalQuery", aug.canonical(), 240));
        ...
        try {
            ...
            if (!executedQuerySafe.isBlank()) {
                run.put("executedQueryHash", SafeRedactor.hashValue(executedQuerySafe));
                run.put("executedQueryLength", executedQuerySafe.length());
            }
            if (!canonicalQuery.isBlank()) {
                run.put("canonicalQueryHash", SafeRedactor.hashValue(canonicalQuery));
                run.put("canonicalQueryLength", canonicalQuery.length());
            }
            ...
            WebFailSoftTraceSuppressions.trace("failSoftRun.summaryTrace", ignore);
        }
        ...
        EcosystemBufferPool poolForCharge = ecosystemBufferPool;
        if (poolForCharge != null) {
            poolForCharge.chargeRawAndTrace(String.valueOf(runId), out);
        }
    ...
    private static Map<String, Object> stageEvent(long runId,
        ...
        Map<String, Object> ev = new LinkedHashMap<>();
        ev.put("runId", runId);
        ev.put("executedQuery", SafeRedactor.diagnosticValue("web.failsoft.domainStagePairs.executedQuery", executedQuery, 260));
        ev.put("canonicalQuery", SafeRedactor.diagnosticValue("web.failsoft.domainStagePairs.canonicalQuery", canonicalQuery, 260));
        ev.put("intent", safeTrim(intent, 60));
        ev.put("url", SafeRedactor.diagnosticValue("web.failsoft.domainStagePairs.url", sn == null ? null : sn.url(), 260));
    ...
    private RerankSourceCredibility boostCredForStage(WebFailSoftStage st, RerankSourceCredibility cred) {
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("credibilityBoost.propsTrace", ignore);
        }

        if (!enabled) {
            try {
                TraceStore.putIfAbsent("web.failsoft.credibilityBoost.enabled", false);
            } catch (Throwable ignore) { WebFailSoftTraceSuppressions.trace("credibilityBoost.disabledTrace", ignore); }
            return c;
        }
        ...
        if (boosted != c) {
            try {
                ...
                WebFailSoftTraceSuppressions.trace("credibilityBoost.countTrace", ignore);
            }
        }
    ...
    private static DeclaredHeader parseDeclaredHeader(@Nullable String raw) {
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("declaredHeader.trim", ignore);
            t = raw;
        }
        if (t == null || t.isBlank()) {
            return null;
        ...
        for (String p : parts) {
            ...
            if ((k.equalsIgnoreCase("WEB") || k.equalsIgnoreCase("WS")) && stage == null) {
                try {
                    ...
                    WebFailSoftTraceSuppressions.trace("declaredHeader.stageParse", ignore);
                }
            } else if (k.equalsIgnoreCase("CRED") && cred == null) {
                try {
                    cred = RerankSourceCredibility.valueOf(v.trim().toUpperCase(Locale.ROOT));
                } catch (Exception ignore) {
                    WebFailSoftTraceSuppressions.trace("declaredHeader.credParse", ignore);
                }
            }
        }
    ...
    private StageDecision classifyDetailed(WebSnippet sn, @Nullable String whitelistProfile) {
        ...
        if (domainProfileLoader != null && url != null && !url.isBlank()) {
            try {
                ...
                WebFailSoftTraceSuppressions.trace("classifyByDomain.profileLookup", ignore);
            }
        }
    ...
    private RerankSourceCredibility credibility(WebSnippet sn) {
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("credibility.declaredHeader", ignore);
        }
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("credibility.authorityLookup", e);
            return RerankSourceCredibility.UNVERIFIED;
        }
    }
    ...
    private static boolean countsTowardMinCitationsFromTaggedOutput(@Nullable String raw) {
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("minCitations.stageParse", ignore);
            return false;
        }
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("minCitations.credParse", ignore);
        ...
        for (int i = out.size() - 1; i >= 0; i--) {
            ...
            if (st != null && !st.isBlank() && selectedCounts != null) {
                try {
                    ...
                    WebFailSoftTraceSuppressions.trace("citeableTailDrop.stageParse", ignore);
                }
            }
            out.remove(i);
            return true;
    ...
    private boolean shouldStarvationFallback(boolean officialOnly,
        ...
        if ("BELOW_MIN_CITATIONS".equals(trigger)) {
            ...
            // webHardDown 상태에서는 extra search(minCitationsRescue/qualityGate rescue)가 실행되지 않는다.
            // 이때 BELOW_MIN_CITATIONS에서 top-up(NO_FILTER_SAFE)까지 defer 하면 officialOnlyStarved 루프가
            // 고착될 수 있으므로, hardDown일 때는 "rescuePossible=false"로 간주해 즉시 top-up을 허용한다.
            boolean rawNonBlank = false;
            try {
                rawNonBlank = toLong(TraceStore.get("web.failsoft.rawInputNonBlankCount")) > 0L;
            } catch (Throwable ignore) {
                WebFailSoftTraceSuppressions.trace("shouldStarvationFallback.rawInputCount", ignore);
                rawNonBlank = false;
            }
            boolean minLiveBudgetUsed = isTruthy(TraceStore.get("web.await.minLiveBudget.used"));
            long skippedCount = toLong(TraceStore.get("web.await.skipped.count"));
            boolean timeoutAll = isTruthy(TraceStore.get("web.await.timeout.all"));
            boolean missingFutureAny = isTruthy(TraceStore.get("web.await.missing_future.any"));

            boolean webHardDownLikely = isTruthy(TraceStore.get("web.hardDown"))
                    || isTruthy(TraceStore.get("orch.webRateLimited.effective"))
                    || isTruthy(TraceStore.get("orch.webRateLimited"))
                    || (!rawNonBlank && skippedCount >= 2 && !minLiveBudgetUsed)
                    || (!rawNonBlank && timeoutAll)
                    || (!rawNonBlank && missingFutureAny);

            boolean blockWhenHardDownLike = props.isMinCitationsRescueBlockWhenWebHardDownLike();
            TraceStore.put("web.failsoft.minCitationsRescue.defer.blockWhenWebHardDownLike", blockWhenHardDownLike);

            if (webHardDownLikely && blockWhenHardDownLike) {
                rescuePossible = false;
                TraceStore.put("web.failsoft.minCitationsRescue.defer.disabled", true);
                TraceStore.put("web.failsoft.minCitationsRescue.defer.disabled.reason", "webHardDown");
            } else if (webHardDownLikely) {
                // Rollback mode: allow defer even when webHardDownLike (for comparison / quick rollback).
                TraceStore.put("web.failsoft.minCitationsRescue.defer.webHardDownLike.butNotBlocked", true);
            }
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("shouldStarvationFallback.skipReasonTrace", ignore);
        }
                ...
                for (Map<String, Object> cand : candidateDiagnostics) {
                    ...
                    if (scoreObj != null) {
                        try {
                            ...
                            WebFailSoftTraceSuppressions.trace("failSoftMetrics.scoreParse", ignore);
                        }
                    }
                }
            }
        } catch (Exception ignore) {
            WebFailSoftTraceSuppressions.trace("failSoftMetrics.record", ignore);
        }
    }
    ...
    private static List<Map<String, Object>> buildHitDetails(WebSnippet sn, List<String> terms, int maxTerms,
        ...
        for (String term : terms) {
            ...
            m.put("term", SafeRedactor.diagnosticValue("web.failsoft.hitDetail.rawText.term", term, 80));
            m.put("pos", pos);
            m.put("slice", SafeRedactor.diagnosticValue("web.failsoft.hitDetail.rawText.slice", sliceAround(baseText, pos, term.length(), window), 240));
            out.add(m);
            added += 1;
            if (added >= maxTerms) {
                break;
    ...
    private static List<WebFailSoftStage> parseStageOrder(List<String> stageNames) {
        ...
        for (String raw : stageNames) {
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("stageList.unknownToken", ignore);
            }
        }
        ...
        for (Map<String, Object> ev : list) {
            ...
            if (wasHard && (isBudgetExhausted || isIntentionalCancel)) {
                try {
                    ...
                    WebFailSoftTraceSuppressions.trace("awaitEvents.normalizeEvent", ignore);
                }
            }
        }
    }
    ...
    private static void summarizeAwaitEventsForTrace() {
        try {
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("awaitEvents.castList", ignore);
                list = null;
            }
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("awaitEvents.normalizeOps", ignore);
            }
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("awaitEvents.contextRead", ignore);
                ctx = null;
            }
            if (ctx != null && !ctx.isEmpty()) {
                for (Map.Entry<String, Object> e : ctx.entrySet()) {
                    ...
                    String key = e.getKey();
                    if (key.startsWith("web.await.skipped.")
                            && (key.endsWith(".count")
                                    || key.endsWith(".last")
                                    || key.endsWith(".last.engine")
                                    || key.endsWith(".last.reason")
                                    || key.endsWith(".last.step"))) {
                        skippedCtx.put(key, e.getValue());
                    }
                    if ("web.await.skipped.last".equals(key)
                            || "web.await.skipped.last.engine".equals(key)
                            || "web.await.skipped.last.reason".equals(key)
                            || "web.await.skipped.last.step".equals(key)) {
                        skippedCtx.put(key, e.getValue());
                    }
                }
            }

            Map<String, Object> summary = WebAwaitEventsSummary.buildTraceEntries(list, skippedCtx);
            for (Map.Entry<String, Object> e : summary.entrySet()) {
                if (e != null && e.getKey() != null) {
                    TraceStore.put(e.getKey(), e.getValue());
                }
            }
        } catch (Throwable ignore) {
            WebFailSoftTraceSuppressions.trace("webFailSoft.preflightBraveBackoff", ignore);
        }
    }
    ...
    private void maybeApplyProviderBackoffFromAwaitSummary() {
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("providerBackoff.providerLookup", ignore);
            backoff = null;
        }
        if (backoff == null) {
            return;
        ...
        try {
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("providerBackoff.naverAwaitDetected", ignore);
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("providerBackoff.naverResetTrace", ignore);
            }
            ...
            if (naverAwaitTimeout > 0L && naverAwaitDetected < naverAwaitTimeout) {
                ...
                try {
                    ...
                    WebFailSoftTraceSuppressions.trace("providerBackoff.naverAwaitReconcileTrace", ignore);
                }
            }
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("providerBackoff.braveAwaitDetected", ignore);
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("providerBackoff.braveResetTrace", ignore);
            }
            ...
            if (braveAwaitTimeout > 0L && braveAwaitDetected < braveAwaitTimeout) {
                ...
                try {
                    ...
                    WebFailSoftTraceSuppressions.trace("providerBackoff.braveAwaitReconcileTrace", ignore);
                }
            }

            // Cancellation / interrupt residue → keep it shallow to avoid poison cascades.
            for (String[] providerSpec : List.of(new String[] { "SerpApi", "serpapi" },
                    new String[] { "Tavily", "tavily" })) {
                String engine = providerSpec[0];
                String provider = providerSpec[1];
                long awaitTimeout = getAnyLong(
                        "web.await.events.summary.engine." + engine + ".cause.await_timeout.count",
                        "web.await.events.summary.engine." + engine + ".cause.awaitTimeout.count");
                long detected = 0L;
                try {
                    detected = toLong(TraceStore.get("web.failsoft.rateLimitBackoff." + provider + ".awaitTimeoutDetected"));
                } catch (Throwable ignore) {
                    WebFailSoftTraceSuppressions.trace("providerBackoff." + provider + "AwaitDetected", ignore);
                    detected = 0L;
                }

                try {
                    TraceStore.put("web.failsoft.rateLimitBackoff." + provider + ".awaitTimeoutReconciledApplyTimes", 0);
                } catch (Throwable ignore) {
                    WebFailSoftTraceSuppressions.trace("providerBackoff." + provider + "ResetTrace", ignore);
                }

                if (awaitTimeout > 0L && detected < awaitTimeout) {
                    long delta = awaitTimeout - detected;
                    int applyTimes = (int) Math.min(delta, 4L);
                    for (int i = 0; i < applyTimes; i++) {
                        backoff.recordFailure(
                                provider,
                    ...
                    try {
                        TraceStore.put("web.failsoft.rateLimitBackoff." + provider + ".awaitTimeoutDetected", awaitTimeout);
                        TraceStore.put("web.failsoft.rateLimitBackoff." + provider + ".awaitTimeoutApplied", true);
                        TraceStore.put("web.failsoft.rateLimitBackoff." + provider + ".awaitTimeoutReconciledDelta", delta);
                        TraceStore.put("web.failsoft.rateLimitBackoff." + provider + ".awaitTimeoutReconciledApplyTimes", applyTimes);
                    } catch (Throwable ignore) {
                        WebFailSoftTraceSuppressions.trace("providerBackoff." + provider + "AwaitReconcileTrace", ignore);
                    }
                }
            }
            ...
            markAwaitCancelledNoBreaker(waited0Engines, "Naver", RateLimitBackoffCoordinator.PROVIDER_NAVER);
            markAwaitCancelledNoBreaker(waited0Engines, "Brave", RateLimitBackoffCoordinator.PROVIDER_BRAVE);
        } catch (Throwable ignore) {
            WebFailSoftTraceSuppressions.trace("providerBackoff.applySummary", ignore);
        }
    }

    private static void markAwaitCancelledNoBreaker(String waited0Engines, String engineLabel, String provider) {
        if (waited0Engines == null || engineLabel == null || provider == null
                || !waited0Engines.contains(engineLabel)) {
            return;
        }
        String p = provider.trim().toLowerCase(Locale.ROOT).replaceAll("[^a-z0-9_.-]+", "_");
        try {
            TraceStore.inc("web.failsoft.cancelled." + p + ".count");
            TraceStore.put("web.failsoft.cancelled." + p + ".lastType", "await_summary");
            TraceStore.put("web.failsoft.cancelled." + p + ".source", "await_summary");
            TraceStore.put("web.failsoft.rateLimitBackoff." + p + ".last.kind", "CANCELLED_NO_BREAKER");
            TraceStore.put("web.failsoft.rateLimitBackoff." + p + ".last.provider", p);
            TraceStore.put("web.failsoft.rateLimitBackoff." + p + ".last.cancelled", true);
            TraceStore.put("web.failsoft.rateLimitBackoff." + p + ".last.source", "await_summary");
            TraceStore.put("web.failsoft.rateLimitBackoff." + p + ".last.tsMs", System.currentTimeMillis());
        } catch (Throwable ignore) {
            WebFailSoftTraceSuppressions.trace("providerBackoff.cancelledTrace", ignore);
        }
    }
    ...
    private static long getAnyLong(String... keys) {
        ...
        for (String k : keys) {
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("providerBackoff.getAnyLong", ignore);
            }
        }
        return 0L;
    }
    ...
    private void recordSoakKpiMinuteSummary(long runId, @Nullable List<String> out) {
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("soakKpiSummary.dedupe", ignore);
        }
        ...
        try {
            ...
            boolean poolSafeEmptyFlag = isTruthy(firstNonNull(
            ...
            boolean starvationFallbackTriggeredFlag = stringOrNull(firstNonNull(
                    TraceStore.get("starvationFallback.trigger"),
                    TraceStore.get("web.failsoft.starvationFallback.trigger"))) != null;
            ...
            soakKpiMinuteSummaryLogger.record(outCount,
                    ...
                    poolSafeEmptyFlag,
                    rescueMergeUsedFlag,
                    vectorFallbackUsedFlag,
                    cacheOnlyMergedCount,
                    tracePoolSize,
                    starvationFallbackTriggeredFlag);
        } catch (Throwable ignore) {
            WebFailSoftTraceSuppressions.trace("soakKpiSummary.record", ignore);
        }
    }
    ...
    private void refreshRateLimitBackoffKpis(int outCount) {
        try {
            ...
            long serpapiRemainingMs = 0L;
            long tavilyRemainingMs = 0L;
            boolean naverSkipped = false;
            boolean braveSkipped = false;
            boolean serpapiSkipped = false;
            boolean tavilySkipped = false;
            ...
            if (backoff != null) {
                try {
                    ...
                    WebFailSoftTraceSuppressions.trace("rateLimitBackoff.naverDecisionTrace", ignore);
                }
                try {
                    RateLimitBackoffCoordinator.Decision bd = backoff
                            .shouldSkip(RateLimitBackoffCoordinator.PROVIDER_BRAVE);
                    ...
                    WebFailSoftTraceSuppressions.trace("rateLimitBackoff.braveDecisionTrace", ignore);
                }
                try {
                    RateLimitBackoffCoordinator.Decision sd = backoff
                            .shouldSkip(RateLimitBackoffCoordinator.PROVIDER_SERPAPI);
                    serpapiSkipped = sd.shouldSkip();
                    serpapiRemainingMs = Math.max(0L, sd.remainingMs());
                    TraceStore.put("web.failsoft.rateLimitBackoff.serpapi.reason", SafeRedactor.traceLabel(stringOrNull(sd.reason())));
                    TraceStore.put("web.failsoft.rateLimitBackoff.serpapi.remainingMs", serpapiRemainingMs);
                } catch (Throwable ignore) {
                    WebFailSoftTraceSuppressions.trace("rateLimitBackoff.serpapiDecisionTrace", ignore);
                }
                try {
                    RateLimitBackoffCoordinator.Decision td = backoff
                            .shouldSkip(RateLimitBackoffCoordinator.PROVIDER_TAVILY);
                    tavilySkipped = td.shouldSkip();
                    tavilyRemainingMs = Math.max(0L, td.remainingMs());
                    TraceStore.put("web.failsoft.rateLimitBackoff.tavily.reason", SafeRedactor.traceLabel(stringOrNull(td.reason())));
                    TraceStore.put("web.failsoft.rateLimitBackoff.tavily.remainingMs", tavilyRemainingMs);
                } catch (Throwable ignore) {
                    WebFailSoftTraceSuppressions.trace("rateLimitBackoff.tavilyDecisionTrace", ignore);
                }
            } else {
                ...
                serpapiRemainingMs = Math.max(0L,
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.serpapi.remainingMs")));
                tavilyRemainingMs = Math.max(0L,
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.tavily.remainingMs")));
                naverSkipped = naverRemainingMs > 0L;
                braveSkipped = braveRemainingMs > 0L;
                serpapiSkipped = serpapiRemainingMs > 0L;
                tavilySkipped = tavilyRemainingMs > 0L;
            }

            long maxRemainingMs = Math.max(Math.max(naverRemainingMs, braveRemainingMs),
                    Math.max(serpapiRemainingMs, tavilyRemainingMs));
            ...
            long serpapiDelayMs = Math.max(0L,
                    toLong(TraceStore.get("web.failsoft.rateLimitBackoff.serpapi.last.delayMs")));
            long tavilyDelayMs = Math.max(0L,
                    toLong(TraceStore.get("web.failsoft.rateLimitBackoff.tavily.last.delayMs")));
            long maxDelayMs = Math.max(Math.max(naverDelayMs, braveDelayMs),
                    Math.max(serpapiDelayMs, tavilyDelayMs));
            ...
            if (tavilySkipped)
                skippedCooldownCount++;
            TraceStore.put("web.failsoft.rateLimitBackoff.skipped.cooldown.count", (long) skippedCooldownCount);
            ...
            long serpapiApply = Math.max(0L,
                    toLong(TraceStore.get("web.failsoft.rateLimitBackoff.serpapi.awaitTimeoutReconciledApplyTimes")));
            long tavilyApply = Math.max(0L,
                    toLong(TraceStore.get("web.failsoft.rateLimitBackoff.tavily.awaitTimeoutReconciledApplyTimes")));
            long totalApply = naverApply + braveApply + serpapiApply + tavilyApply;
            ...
            WebFailSoftTraceSuppressions.trace("rateLimitBackoff.cooldownTradeoff", ignore);
        }
    }
    ...
    private static String computeOrchDigestForSoak(Map<String, Object> kpi) {
        try {
            ...
            d.put("serpapi.skipped.reason", kpi.get("web.serpapi.skipped.reason"));
            d.put("tavily.skipped.reason", kpi.get("web.tavily.skipped.reason"));
            ...
            d.put("serpapi.last.kind", kpi.get("web.failsoft.rateLimitBackoff.serpapi.last.kind"));
            d.put("tavily.last.kind", kpi.get("web.failsoft.rateLimitBackoff.tavily.last.kind"));
            ...
            WebFailSoftTraceSuppressions.trace("soakKpi.orchDigest", ignore);
            return "";
        }
    }
    ...
    private void emitSoakWarnJson(String warnEvent, long runId, Map<String, Object> baseKpi,
        ...
        } catch (Exception ignore) { WebFailSoftTraceSuppressions.trace("soakKpi.emit", ignore); }
    }
    ...
    private void emitSoakKpiJson(long runId, Map<String, Integer> stageCountsSelectedFromOut, List<String> out) {
        boolean emitJson = props != null && props.isEmitSoakKpiJson();
        boolean captureLast = webSoakKpiLastStore != null;
        if (!emitJson && !captureLast) {
            return;
        }
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("soakKpiJson.dedupe", ignore);
        }
        ...
        try {
            ...
            boolean cacheOnlyUsed = isTruthy(firstNonNull(TraceStore.get("web.failsoft.hybridEmptyFallback.cacheOnly.used"), TraceStore.get("cacheOnly.used")));
            boolean naverSkipped = isTruthy(TraceStore.get("web.naver.skipped")), braveSkipped = isTruthy(TraceStore.get("web.brave.skipped")), serpapiSkipped = isTruthy(TraceStore.get("web.serpapi.skipped")), tavilySkipped = isTruthy(TraceStore.get("web.tavily.skipped"));

            long cacheMerged = toLong(firstNonNull(
                    TraceStore.get("cacheOnly.merged.count"),
                    TraceStore.get("web.failsoft.hybridEmptyFallback.cacheOnly.merged.count")));

            long tracePoolSize = Math.max(TraceStore.getPoolItems().size(), toLong(firstNonNull(
                    TraceStore.get("tracePool.size"),
                    TraceStore.get("web.failsoft.hybridEmptyFallback.cacheOnly.rescueMerge.tracePool.size"))));

            boolean rescueMergeUsed = !TraceStore.getPoolItems().isEmpty() || isTruthy(firstNonNull(
                    TraceStore.get("rescueMerge.used"),
                    TraceStore.get("web.failsoft.hybridEmptyFallback.cacheOnly.rescueMerge.used")));

            String starvationTrigger = stringOrNull(firstNonNull(TraceStore.get("starvationFallback.trigger"),
            ...
            String providerBrave = safeTrim(stringOrNull(TraceStore.get("provider.brave")), 32);
            String providerNaver = safeTrim(stringOrNull(TraceStore.get("provider.naver")), 32);
            String providerSerpapi = safeTrim(stringOrNull(TraceStore.get("provider.serpapi")), 32);
            String providerTavily = safeTrim(stringOrNull(TraceStore.get("provider.tavily")), 32);
            Map<String, Object> provider = new LinkedHashMap<>();
            provider.put("brave", ai.abandonware.nova.orch.web.ProviderStateNormalizer.state(providerBrave, braveSkipped, cacheOnlyUsed && toLong(TraceStore.get("web.failsoft.hybridEmptyFallback.cacheOnly.brave.count")) > 0L));
            provider.put("naver", ai.abandonware.nova.orch.web.ProviderStateNormalizer.state(providerNaver, naverSkipped, isTruthy(TraceStore.get("web.naver.cacheOnlyFuture.used")) || isTruthy(TraceStore.get("web.naver.cacheOnly.timeoutRescue.used")) || (cacheOnlyUsed && toLong(TraceStore.get("web.failsoft.hybridEmptyFallback.cacheOnly.naver.count")) > 0L)));
            provider.put("serpapi", ai.abandonware.nova.orch.web.ProviderStateNormalizer.state(providerSerpapi, serpapiSkipped, false));
            provider.put("tavily", ai.abandonware.nova.orch.web.ProviderStateNormalizer.state(providerTavily, tavilySkipped, false));
            Object serpapiSummaryState = ((providerSerpapi != null && !providerSerpapi.isBlank()) || serpapiSkipped) ? provider.get("serpapi") : null;
            Object tavilySummaryState = ((providerTavily != null && !providerTavily.isBlank()) || tavilySkipped) ? provider.get("tavily") : null;
            String providerStatus = ai.abandonware.nova.orch.web.ProviderStateNormalizer.summary(
                    provider.get("naver"),
                    provider.get("brave"),
                    serpapiSummaryState,
                    tavilySummaryState);
            Object stageCountsForKpi = stageCountsSelectedFromOut;
            if (!(stageCountsForKpi instanceof Map<?, ?>)) {
                stageCountsForKpi = firstNonNull(
            ...
            Map<?, ?> stageCountsSelectedForKpi =
                    stageCountsForKpi instanceof Map<?, ?> m ? m : Collections.emptyMap();
            Map<String, Object> j = new LinkedHashMap<>();
            j.put("event", "soak.web.kpi");
            j.put("tsMs", tsMs);
            j.put("rid", SafeRedactor.hashValue(rid));
            j.put("sessionId", SafeRedactor.hashValue(sessionId));
            j.put("provider", provider);
            j.put("providerStatus", providerStatus);
            j.put("outCount", out == null ? 0 : out.size());
            j.put("stageCountsSelectedFromOut", stageCountsSelectedForKpi);
            j.put("cacheOnly.merged.count", cacheMerged);
            j.put("tracePool.size", tracePoolSize);
            j.put("rescueMerge.used", rescueMergeUsed);
            j.put("vectorFallback.used", isTruthy(firstNonNull(TraceStore.get("vectorFallback.used"), TraceStore.get("retrieval.vectorFallback.used"))));
            j.put("vectorFallback.reason", SafeRedactor.traceLabelOrFallback(firstNonNull(
                    TraceStore.get("vectorFallback.reason"),
                    TraceStore.get("retrieval.vectorFallback.reason")), ""));
            j.put("vectorFallback.effectiveTopK", toLong(firstNonNull(
            ...
            ai.abandonware.nova.orch.ecosystem.EcosystemKpiFields.putTraceKpi(j);
            try {
                ...
                WebFailSoftTraceSuppressions.trace("soakKpiJson.rawInput", ignore);
            }
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("soakKpiJson.hybridFallback", ignore);
            }
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("soakKpiJson.partialDown", ignore);
            }

            // DC-0~DC-4 matching helpers
            try {
                outCount = out == null ? 0 : out.size();
                long nofilterSafeCount = 0L;
                nofilterSafeCount += toLong(stageCountsSelectedForKpi.get("NOFILTER_SAFE"));
                nofilterSafeCount += toLong(stageCountsSelectedForKpi.get("NOFILTER_SAFE_PRIORITY"));
                ...
                WebFailSoftTraceSuppressions.trace("soakKpiJson.nofilterSafe", ignore);
            }

            try {
                for (String p : List.of("naver", "brave", "serpapi", "tavily")) {
                    String prefix = "web." + p; Object skippedReason = TraceStore.get(prefix + ".skipped.reason"); boolean skipped = "naver".equals(p) ? naverSkipped : ("brave".equals(p) ? braveSkipped : ("serpapi".equals(p) ? serpapiSkipped : (isTruthy(TraceStore.get(prefix + ".skipped")) || skippedReason != null)));
                    j.put(prefix + ".skipped", skipped);
                    j.put(prefix + ".skipped.reason", SafeRedactor.traceLabelOrFallback(skippedReason, ""));
                    j.put(prefix + ".providerDisabled", isTruthy(TraceStore.get(prefix + ".providerDisabled"))); j.put(prefix + ".disabledReason", SafeRedactor.traceLabelOrFallback(TraceStore.get(prefix + ".disabledReason"), ""));
                    j.put(prefix + ".failureReason", SafeRedactor.traceLabelOrFallback(TraceStore.get(prefix + ".failureReason"), "")); j.put(prefix + ".providerEmpty", isTruthy(TraceStore.get(prefix + ".providerEmpty")));
                    j.put(prefix + ".afterFilterStarved", isTruthy(TraceStore.get(prefix + ".afterFilterStarved"))); j.put(prefix + ".rateLimited", isTruthy(TraceStore.get(prefix + ".rateLimited")));
                    j.put(prefix + ".retryAfterMs", toLong(TraceStore.get(prefix + ".retryAfterMs")));
                }
            } catch (Throwable ignore) {
                WebFailSoftTraceSuppressions.trace("soakKpiJson.providerDigest", ignore);
            }
            try {
                ...
                for (String providerName : List.of("serpapi", "tavily")) {
                    String prefix = "web.failsoft.rateLimitBackoff." + providerName;
                    j.put(prefix + ".reason",
                            safeTrim(stringOrNull(TraceStore.get(prefix + ".reason")), 64));
                    j.put(prefix + ".remainingMs",
                            toLong(TraceStore.get(prefix + ".remainingMs")));
                    j.put(prefix + ".justStarted",
                            isTruthy(TraceStore.get(prefix + ".justStarted")));
                    j.put(prefix + ".skipped.tsMs",
                            toLong(TraceStore.get(prefix + ".skipped.tsMs")));
                    j.put(prefix + ".timeoutDetected",
                            toLong(TraceStore.get(prefix + ".timeoutDetected")));
                    j.put(prefix + ".awaitTimeoutDetected",
                            toLong(TraceStore.get(prefix + ".awaitTimeoutDetected")));
                    j.put(prefix + ".awaitTimeoutApplied",
                            isTruthy(TraceStore.get(prefix + ".awaitTimeoutApplied")));
                    j.put(prefix + ".awaitTimeoutApplied.timeoutMs",
                            toLong(TraceStore.get(prefix + ".awaitTimeoutApplied.timeoutMs")));
                    j.put(prefix + ".awaitTimeoutApplied.waitedMs",
                            toLong(TraceStore.get(prefix + ".awaitTimeoutApplied.waitedMs")));
                    j.put(prefix + ".awaitTimeoutApplied.tsMs",
                            toLong(TraceStore.get(prefix + ".awaitTimeoutApplied.tsMs")));
                    j.put(prefix + ".awaitTimeoutApplied.remainingMs",
                            toLong(TraceStore.get(prefix + ".awaitTimeoutApplied.remainingMs")));
                }
                ...
                try {
                            ...
                            if (nRem <= 0L) {
                                ...
                                if (dn != null && dn.shouldSkip()) {
                                    ...
                                    if (stringOrNull(j.get("web.failsoft.rateLimitBackoff.naver.reason")) == null) {
                                        j.put("web.failsoft.rateLimitBackoff.naver.reason", SafeRedactor.traceLabel(reason));
                                    }
                                    ...
                                    try {
                                        ...
                                        if (stringOrNull(
                                            ...
                                            TraceStore.put("web.failsoft.rateLimitBackoff.naver.reason",
                                                    SafeRedactor.traceLabel(reason));
                                        }
                                        TraceStore.put("web.failsoft.rateLimitBackoff.naver.justStarted", justStarted);
                                    } catch (Throwable ignore2) {
                                        WebFailSoftTraceSuppressions.trace("soakKpiJson.naverBackfillTraceStore", ignore2);
                                    }
                                }
                            }
                            ...
                            if (bRem <= 0L) {
                                ...
                                if (db != null && db.shouldSkip()) {
                                    ...
                                    if (stringOrNull(j.get("web.failsoft.rateLimitBackoff.brave.reason")) == null) {
                                        j.put("web.failsoft.rateLimitBackoff.brave.reason", SafeRedactor.traceLabel(reason));
                                    }
                                    ...
                                    try {
                                        ...
                                        WebFailSoftTraceSuppressions.trace("soakKpiJson.braveBackfillTraceStore", ignore2);
                                    }
                                }
                            }
                        }
                    ...
                    WebFailSoftTraceSuppressions.trace("soakKpiJson.backfillCoordinator", ignore);
                }
            } catch (Throwable ignore) {
                WebFailSoftTraceSuppressions.trace("soakKpiJson.backfillOuter", ignore);
            }
            ...
            try {
                ...
                // Backoff decision breakdown (base=max(expBackoff,hint) -> jitter -> cap)
                j.put("web.failsoft.rateLimitBackoff.naver.last.expBackoffMs",
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.naver.last.expBackoffMs")));
                j.put("web.failsoft.rateLimitBackoff.naver.last.baseMs",
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.naver.last.baseMs")));
                j.put("web.failsoft.rateLimitBackoff.naver.last.jitterMs",
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.naver.last.jitterMs")));
                j.put("web.failsoft.rateLimitBackoff.naver.last.capMs",
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.naver.last.capMs")));
                // (429) Retry-After hints
                j.put("web.failsoft.rateLimitBackoff.naver.last.retryAfterMs",
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.naver.last.retryAfterMs")));
                j.put("web.failsoft.rateLimitBackoff.naver.last.retryAfterParsedMs",
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.naver.last.retryAfterParsedMs")));
                // (AWAIT_TIMEOUT) join-timebox hint
                j.put("web.failsoft.rateLimitBackoff.naver.last.timeoutHintMs",
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.naver.last.timeoutHintMs")));
                // Backward-compatible alias
                j.put("web.failsoft.rateLimitBackoff.naver.last.hintMs",
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.naver.last.hintMs")));
                ...
                // Backoff decision breakdown (base=max(expBackoff,hint) -> jitter -> cap)
                j.put("web.failsoft.rateLimitBackoff.brave.last.expBackoffMs",
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.brave.last.expBackoffMs")));
                j.put("web.failsoft.rateLimitBackoff.brave.last.baseMs",
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.brave.last.baseMs")));
                j.put("web.failsoft.rateLimitBackoff.brave.last.jitterMs",
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.brave.last.jitterMs")));
                j.put("web.failsoft.rateLimitBackoff.brave.last.capMs",
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.brave.last.capMs")));
                // (429) Retry-After hints
                j.put("web.failsoft.rateLimitBackoff.brave.last.retryAfterMs",
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.brave.last.retryAfterMs")));
                j.put("web.failsoft.rateLimitBackoff.brave.last.retryAfterParsedMs",
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.brave.last.retryAfterParsedMs")));
                // (AWAIT_TIMEOUT) join-timebox hint
                j.put("web.failsoft.rateLimitBackoff.brave.last.timeoutHintMs",
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.brave.last.timeoutHintMs")));
                // Backward-compatible alias
                j.put("web.failsoft.rateLimitBackoff.brave.last.hintMs",
                        toLong(TraceStore.get("web.failsoft.rateLimitBackoff.brave.last.hintMs")));
                for (String providerName : List.of("serpapi", "tavily")) {
                    String prefix = "web.failsoft.rateLimitBackoff." + providerName + ".last";
                    j.put(prefix + ".kind",
                            safeTrim(stringOrNull(TraceStore.get(prefix + ".kind")), 32));
                    j.put(prefix + ".streak",
                            toLong(TraceStore.get(prefix + ".streak")));
                    j.put(prefix + ".delayMs",
                            toLong(TraceStore.get(prefix + ".delayMs")));
                    j.put(prefix + ".capHit",
                            isTruthy(TraceStore.get(prefix + ".capHit")));
                    j.put(prefix + ".expBackoffMs",
                            toLong(TraceStore.get(prefix + ".expBackoffMs")));
                    j.put(prefix + ".baseMs",
                            toLong(TraceStore.get(prefix + ".baseMs")));
                    j.put(prefix + ".jitterMs",
                            toLong(TraceStore.get(prefix + ".jitterMs")));
                    j.put(prefix + ".capMs",
                            toLong(TraceStore.get(prefix + ".capMs")));
                    j.put(prefix + ".retryAfterMs",
                            toLong(TraceStore.get(prefix + ".retryAfterMs")));
                    j.put(prefix + ".retryAfterParsedMs",
                            toLong(TraceStore.get(prefix + ".retryAfterParsedMs")));
                    j.put(prefix + ".timeoutHintMs",
                            toLong(TraceStore.get(prefix + ".timeoutHintMs")));
                    j.put(prefix + ".hintMs",
                            toLong(TraceStore.get(prefix + ".hintMs")));
                }
            } catch (Throwable ignore) {
                WebFailSoftTraceSuppressions.trace("soakKpiJson.rateLimitBackoff", ignore);
            }
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("soakKpiJson.minCitationsPreflight", ignore);
            }
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("soakKpiJson.keywordSelection", ignore);
            }

            // Await summary (Hybrid await events)
            try {
                // Coarse "all down" flags used by hardDownLike detection / tuning.
                j.put("web.await.ok.count", toLong(TraceStore.get("web.await.ok.count")));
                j.put("web.await.skipped.count", toLong(TraceStore.get("web.await.skipped.count")));
                j.put("web.await.timeout.count", toLong(TraceStore.get("web.await.timeout.count")));
                j.put("web.await.timeout.all", isTruthy(TraceStore.get("web.await.timeout.all")));
                // Alias (dashboard/grep compatibility)
                j.put("web.await.events.timeoutAll", isTruthy(TraceStore.get("web.await.timeout.all")));
                j.put("web.await.missing_future.any", isTruthy(TraceStore.get("web.await.missing_future.any")));
                ...
                j.put("web.await.events.summary.engine.SerpApi.cause.await_timeout.count",
                        toLong(firstNonNull(
                                TraceStore.get("web.await.events.summary.engine.SerpApi.cause.await_timeout.count"),
                                TraceStore.get("web.await.events.summary.engine.SerpApi.cause.awaitTimeout.count"))));
                j.put("web.await.events.summary.engine.Tavily.cause.await_timeout.count",
                        toLong(firstNonNull(
                                TraceStore.get("web.await.events.summary.engine.Tavily.cause.await_timeout.count"),
                                TraceStore.get("web.await.events.summary.engine.Tavily.cause.awaitTimeout.count"))));
            } catch (Throwable ignore) {
                WebFailSoftTraceSuppressions.trace("soakKpiJson.awaitSummary", ignore);
            }
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("soakKpiJson.braveCooldown", ignore);
            }

            // OpenAI Chat/Responses model-guard breadcrumbs (DC-1)
            try {
                j.put("llm.modelGuard.triggered", isTruthy(TraceStore.get("llm.modelGuard.triggered")));
                j.put("llm.modelGuard.mode", safeTrim(stringOrNull(TraceStore.get("llm.modelGuard.mode")), 64));
                j.put("llm.modelGuard.endpoint",
                        safeTrim(stringOrNull(TraceStore.get("llm.modelGuard.endpoint")), 128));
                j.put("llm.modelGuard.failReason",
                        safeTrim(stringOrNull(TraceStore.get("llm.modelGuard.failReason")), 96));
                j.put("llm.modelGuard.requestedModelHash",
                        safeTrim(stringOrNull(TraceStore.get("llm.modelGuard.requestedModelHash")), 96));
                j.put("llm.modelGuard.requestedModelLength",
                        toLong(TraceStore.get("llm.modelGuard.requestedModelLength")));
                j.put("llm.modelGuard.substituteChatModelHash",
                        safeTrim(stringOrNull(TraceStore.get("llm.modelGuard.substituteChatModelHash")), 96));
                j.put("llm.modelGuard.substituteChatModelLength",
                        toLong(TraceStore.get("llm.modelGuard.substituteChatModelLength")));
            } catch (Throwable ignore) {
                WebFailSoftTraceSuppressions.trace("soakKpiJson.modelGuard", ignore);
            }
            ...
            try {
                ...
                if (mr instanceof Number)
                    ...
                    try {
                        ...
                        WebFailSoftTraceSuppressions.trace("soakKpiJson.starvationFallbackMaxRatio", ignore);
                        maxRatio = 0.0;
                    }
                }
                ...
                WebFailSoftTraceSuppressions.trace("soakKpiJson.starvationFallbackRatio", ignore);
            }
            ...
            try {
                ...
                String serpapiReason = String.valueOf(j.getOrDefault("web.serpapi.skipped.reason", "")).trim();
                String tavilyReason = String.valueOf(j.getOrDefault("web.tavily.skipped.reason", "")).trim();
                ...
                if (serpapiSkipped)
                    chain.add("serpapiSkipped" + (StringUtils.hasText(serpapiReason) ? ":" + serpapiReason : ""));
                if (tavilySkipped)
                    chain.add("tavilySkipped" + (StringUtils.hasText(tavilyReason) ? ":" + tavilyReason : ""));
                ...
                try {
                    ...
                    WebFailSoftTraceSuppressions.trace("soakKpiJson.nofilterSafeRatio", ignore);
                    nfs = 0.0;
                }
                ...
                if (mr instanceof Number)
                    ...
                    try {
                        ...
                        WebFailSoftTraceSuppressions.trace("soakKpiJson.decisionChainMaxRatio", ignore);
                        maxRatio = 0.0;
                    }
                }
                ...
                WebFailSoftTraceSuppressions.trace("soakKpiJson.decisionChain", ignore);
            }
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("soakKpiJson.naverCooldownTransition", ignore);
            }
            try {
                ...
                WebFailSoftTraceSuppressions.trace("soakKpiJson.braveCooldownTransition", ignore);
            }
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("soakKpiJson.edgeTargetCount", ignore);
            }

            try {
                boolean qtxActive = isTruthy(TraceStore.get("qtx.softCooldown.active"));
                String ksMode = safeTrim(stringOrNull(TraceStore.get("keywordSelection.mode")), 48);

                // Keep backward-compatibility: old dashboards searched for "qtxGate" in mode.
                boolean ksModeSignalsQtx = ksMode != null
                        && (ksMode.contains("qtxSoftCooldown") || ksMode.contains("qtxGate"));
                boolean qtxGateFlag = isTruthy(TraceStore.get("keywordSelection.qtxGate"));
                boolean qtxSoftCooldownFlag = isTruthy(TraceStore.get("keywordSelection.qtxSoftCooldown"));
                boolean qtxSoftAllowLegacy = isTruthy(TraceStore.get("keywordSelection.qtxGate.softAllow.used"));
                boolean qtxOneShotLegacy = isTruthy(
                        TraceStore.get("keywordSelection.qtxGate.softAllow.oneShotAttempted"));
                boolean qtxOneShotUsed = isTruthy(TraceStore.get("keywordSelection.qtxSoftCooldown.oneShot.used"));

                boolean qtxObserved = ksModeSignalsQtx
                        || qtxGateFlag
                        || qtxSoftCooldownFlag
                        || qtxSoftAllowLegacy
                        || qtxOneShotLegacy
                ...
                // Direct breadcrumbs (raw, grep-friendly)
                j.put("keywordSelection.mode", ksMode);
                j.put("keywordSelection.qtxSoftCooldown.oneShot.used", qtxOneShotUsed);

                // Backward-compatible derived KPI (legacy keyspace)
                j.put("kpi.qtxGate.expected", qtxActive);
                j.put("kpi.qtxGate.observed", qtxObserved);
                j.put("kpi.qtxGate.mode", ksMode);
                j.put("kpi.qtxGate.mustAtLeastOne", mustAtLeastOne);
                j.put("kpi.qtxGate.violation", qtxActive && (!qtxObserved || !mustAtLeastOne));

                // New derived KPI keyspace (qtxSoftCooldown)
                j.put("kpi.qtxSoftCooldown.expected", qtxActive);
                j.put("kpi.qtxSoftCooldown.observed", qtxObserved);
                j.put("kpi.qtxSoftCooldown.mode", ksMode);
                j.put("kpi.qtxSoftCooldown.oneShot.used", qtxOneShotUsed);
                j.put("kpi.qtxSoftCooldown.mustAtLeastOne", mustAtLeastOne);
                j.put("kpi.qtxSoftCooldown.violation", qtxActive && (!qtxObserved || !mustAtLeastOne));
            } catch (Throwable ignore) {
                WebFailSoftTraceSuppressions.trace("soakKpiJson.qtxSoftCooldownKpi", ignore);
            }

            try {
                boolean allSkipped = ai.abandonware.nova.orch.web.ProviderStateNormalizer.allSkipped(
                        provider.get("naver"),
                        provider.get("brave"),
                        serpapiSummaryState,
                        tavilySummaryState);
                ...
                WebFailSoftTraceSuppressions.trace("soakKpiJson.nextAllSkippedKpi", ignore);
            }
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("soakKpiJson.remergeOnce", ignore);
            }
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("soakKpiJson.orchDigestStore", ignore);
            }
            ...
            try {
                ...
                WebFailSoftTraceSuppressions.trace("soakKpiJson.lastTraceStore", ignore);
            }
            if (captureLast) {
                try {
                    webSoakKpiLastStore.update(j, json);
                } catch (Throwable ignore) {
                    WebFailSoftTraceSuppressions.trace("soakKpiJson.lastStore", ignore);
                }
            }
            if (emitJson) {
                ...
                if ("runaway".equalsIgnoreCase(tradeoffClass)) {
                    ...
                    extra.put("web.failsoft.rateLimitBackoff.brave.last.kind",
                            safeTrim(stringOrNull(TraceStore.get("web.failsoft.rateLimitBackoff.brave.last.kind")),
                                    32));
                    extra.put("web.failsoft.rateLimitBackoff.serpapi.last.kind",
                            safeTrim(stringOrNull(TraceStore.get("web.failsoft.rateLimitBackoff.serpapi.last.kind")),
                                    32));
                    extra.put("web.failsoft.rateLimitBackoff.tavily.last.kind",
                            safeTrim(stringOrNull(TraceStore.get("web.failsoft.rateLimitBackoff.tavily.last.kind")),
                                    32));
            ...
            WebFailSoftTraceSuppressions.trace("soakKpiJson.warnJson", ignore);
        }
    } catch (Throwable ignore) {
        WebFailSoftTraceSuppressions.trace("soakKpiJson.outer", ignore);
    }
    }
    ...
    private static long toLong(Object o) {
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("soakKpiJson.toLong", ignore);
            return 0L;
        }
    }
