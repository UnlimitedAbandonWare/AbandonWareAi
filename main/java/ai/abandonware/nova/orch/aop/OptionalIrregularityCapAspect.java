...
public class OptionalIrregularityCapAspect {
    ...
    public OptionalIrregularityCapAspect(boolean enabled, double deltaCap, double ceiling, int maxEvents) {
        ...
        this.deltaCap = nonNegativeFinite(deltaCap);
        this.ceiling = nonNegativeFinite(ceiling);
    ...
    public Object aroundBump(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            if (ctx.isHighRiskQuery()) {
                ...
                TraceStore.put("irregularity.optional.cap.skippedHighRisk.reason",
                        SafeRedactor.traceLabelOrFallback(r, ""));
                return pjp.proceed();
            }
        } catch (Throwable ignore) {
            WebFailSoftTraceSuppressions.trace("optionalIrregularityCap.highRiskCheck", ignore);
        }
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("optionalIrregularityCap.counterUpdate", ignore);
        }
    ...
    private static double getNumber(Object v) {
        ...
        if (v instanceof String s) {
            try {
                ...
                WebFailSoftTraceSuppressions.trace("optionalIrregularityCap.parseNumber", ignore);
                return 0.0;
            }
        }
        return 0.0;
