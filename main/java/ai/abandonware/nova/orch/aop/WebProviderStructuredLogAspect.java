...
public class WebProviderStructuredLogAspect {
    ...
    private Object around(String engine, String breakerKey, ProceedingJoinPoint pjp) throws Throwable {
        ...
        appendEvent(eventMap(
                ...
                "engine", engine,
                "phase", "start",
                "qHash", com.example.lms.trace.SafeRedactor.hashValue(q),
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug("[Nova][web.provider] engine={} failureReason={} errorType={} httpStatus={}{}",
                        engine,
                        "web_provider_failed",
    ...
    private static long nextSeq() {
        try {
            ...
            WebFailSoftTraceSuppressions.trace("webProviderStructured.nextSeq", ignore);
    ...
    private static void appendEvent(Map<String, Object> base) {
        try {
            ...
            WebFailSoftTraceSuppressions.trace("webProviderStructured.appendEvent", ignore);
        }
    }
    ...
    private String breakerState(String key) {
        try {
            ...
            WebFailSoftTraceSuppressions.trace("webProviderStructured.breakerState", ignore);
            return null;
        }
    }
    ...
    private static int safeOutCount(String engine, Object out) {
        try {
            ...
            WebFailSoftTraceSuppressions.trace("webProviderStructured.safeOutCount", ignore);
            return -1;
        }
    }
    ...
    private static String safeStatus(String engine, Object out) {
        try {
            ...
            WebFailSoftTraceSuppressions.trace("webProviderStructured.safeStatus", ignore);
        }
        return null;
    }
    ...
    private static Integer safeInt(Object o) {
        ...
        try {
            ...
            WebFailSoftTraceSuppressions.trace("webProviderStructured.safeInt", ignore);
            return null;
        }
    ...
    private static Integer safeHttpStatus(String engine, Object out) {
        try {
            ...
            WebFailSoftTraceSuppressions.trace("webProviderStructured.safeHttpStatus", ignore);
        }
        return null;
    }
        ...
        for (int i = 0; i < 10 && cur != null; i++) {
            if (cur instanceof WebClientResponseException wcre) {
                try {
                    ...
                    WebFailSoftTraceSuppressions.trace("webProviderStructured.extractHttpStatus", ignore);
                    return null;
                }
            }
            cur = cur.getCause();
