...
public final class AnchorTailQueryCompressor {
    ...
    private static final System.Logger LOG = System.getLogger(AnchorTailQueryCompressor.class.getName());
    ...
    public static Result condenseKeepAnchorAndTail(String original, int maxLen, AnchorNarrower anchorNarrower) {
        ...
        try {
            ...
            traceSkipped("anchorTail.keepAnchorAndTail", e);
    ...
    public static Result condenseForQueryAnalysis(String original, int maxLen, AnchorNarrower anchorNarrower) {
        ...
        try {
            ...
            traceSkipped("anchorTail.queryAnalysis", e);
    ...
    private static String pickAnchor(AnchorNarrower anchorNarrower, String text, int maxLen) {
        ...
        if (anchorNarrower != null) {
            try {
                ...
                traceSkipped("anchorTail.pickAnchor", ignored);
    ...
    private static void traceSkipped(String stage, Throwable failure) {
        ...
        try {
            TraceStore.put("anchorTail.suppressed.stage", safeStage);
            TraceStore.put("anchorTail.suppressed.errorType", errorType);
            TraceStore.put("anchorTail.suppressed." + safeStage, true);
            TraceStore.put("anchorTail.suppressed." + safeStage + ".errorType", errorType);
        } catch (RuntimeException traceFailure) {
            LOG.log(System.Logger.Level.DEBUG,
                    "Anchor tail trace skipped stage=" + safeStage
