...
public final class ChunkEnvelope {
    ...
    private static final System.Logger LOG = System.getLogger(ChunkEnvelope.class.getName());
    ...
    private static Integer safeInt(String s) {
        try {
            ...
            traceParseSkipped("safe_int", error);
            return null;
        }
    }
    ...
    public static final class Meta {
        ...
        private static Integer findInt(String json, String key) {
            try {
                ...
                traceParseSkipped("meta_int", error);
            }
            return null;
        }
    ...
    private static void traceParseSkipped(String stage, Exception error) {
        LOG.log(System.Logger.Level.DEBUG,
                "Chunk envelope parse skipped stage=" + stage + " errorType=" + errorType(error));
    }
