...
public class NovaOrchestrationProperties {
    ...
    public static class RagCompressorProps {
        ...
        private boolean ablationGuidedEnabled = true;
        private double ablationPressureThreshold = 0.55d;
        private boolean anchorProbeEnabled = true;
        private String probeMode = "spread";
        private List<Integer> anchorProbeKSchedule = List.of(32, 16, 8, 3);
        private int anchorProbeFinalMinDocs = 1;
        private int anchorProbeFinalMaxDocs = 3;
        private List<Integer> spreadProbeKSchedule = List.of(64, 48, 32, 16, 5);
        private int spreadProbeFinalMinDocs = 3;
        private int spreadProbeFinalMaxDocs = 5;
        private double spreadProbeMinAnchorDiversity = 0.30d;
        private boolean dynamicGateEnabled = true;
        private double matrixTileMaxShare = 0.60d;
        private double noiseRiskThreshold = 0.70d;
        ...
        public boolean isAblationGuidedEnabled() {
            return ablationGuidedEnabled;
        }

        public void setAblationGuidedEnabled(boolean ablationGuidedEnabled) {
            this.ablationGuidedEnabled = ablationGuidedEnabled;
        }

        public double getAblationPressureThreshold() {
            return ablationPressureThreshold;
        }

        public void setAblationPressureThreshold(double ablationPressureThreshold) {
            this.ablationPressureThreshold = ablationPressureThreshold;
        }
        ...
        public void setProbeMode(String probeMode) {
            this.probeMode = (probeMode == null || probeMode.isBlank()) ? "spread" : probeMode.trim();
        }

        public List<Integer> getAnchorProbeKSchedule() {
            return anchorProbeKSchedule;
        }

        public void setAnchorProbeKSchedule(List<Integer> anchorProbeKSchedule) {
            this.anchorProbeKSchedule = (anchorProbeKSchedule == null || anchorProbeKSchedule.isEmpty())
                    ? List.of(32, 16, 8, 3)
                    : List.copyOf(anchorProbeKSchedule);
        }

        public int getAnchorProbeFinalMinDocs() {
            return anchorProbeFinalMinDocs;
        }

        public void setAnchorProbeFinalMinDocs(int anchorProbeFinalMinDocs) {
            this.anchorProbeFinalMinDocs = anchorProbeFinalMinDocs;
        }

        public int getAnchorProbeFinalMaxDocs() {
            return anchorProbeFinalMaxDocs;
        }

        public void setAnchorProbeFinalMaxDocs(int anchorProbeFinalMaxDocs) {
            this.anchorProbeFinalMaxDocs = anchorProbeFinalMaxDocs;
        }

        public List<Integer> getSpreadProbeKSchedule() {
            return spreadProbeKSchedule;
        }

        public void setSpreadProbeKSchedule(List<Integer> spreadProbeKSchedule) {
            this.spreadProbeKSchedule = (spreadProbeKSchedule == null || spreadProbeKSchedule.isEmpty())
                    ? List.of(64, 48, 32, 16, 5)
                    : List.copyOf(spreadProbeKSchedule);
        }

        public int getSpreadProbeFinalMinDocs() {
            return spreadProbeFinalMinDocs;
        }

        public void setSpreadProbeFinalMinDocs(int spreadProbeFinalMinDocs) {
            this.spreadProbeFinalMinDocs = spreadProbeFinalMinDocs;
        }

        public int getSpreadProbeFinalMaxDocs() {
            return spreadProbeFinalMaxDocs;
        }

        public void setSpreadProbeFinalMaxDocs(int spreadProbeFinalMaxDocs) {
            this.spreadProbeFinalMaxDocs = spreadProbeFinalMaxDocs;
        }

        public double getSpreadProbeMinAnchorDiversity() {
            return spreadProbeMinAnchorDiversity;
        }

        public void setSpreadProbeMinAnchorDiversity(double spreadProbeMinAnchorDiversity) {
            this.spreadProbeMinAnchorDiversity = spreadProbeMinAnchorDiversity;
        }

        public boolean isDynamicGateEnabled() {
            return dynamicGateEnabled;
        }

        public void setDynamicGateEnabled(boolean dynamicGateEnabled) {
            this.dynamicGateEnabled = dynamicGateEnabled;
        }

        public double getMatrixTileMaxShare() {
            return matrixTileMaxShare;
        }

        public void setMatrixTileMaxShare(double matrixTileMaxShare) {
            this.matrixTileMaxShare = matrixTileMaxShare;
        }

        public double getNoiseRiskThreshold() {
            return noiseRiskThreshold;
        }

        public void setNoiseRiskThreshold(double noiseRiskThreshold) {
            this.noiseRiskThreshold = noiseRiskThreshold;
        }
        ...
        public int getMemoryMaxLines() {
            return memoryMaxLines;
        }

        public void setMemoryMaxLines(int memoryMaxLines) {
            this.memoryMaxLines = memoryMaxLines;
        }
        ...
        public double getMemoryContaminationThreshold() {
            return memoryContaminationThreshold;
        }
    ...
    public static class ExtremeZProps {
        ...
        private boolean riskGateEnabled = true;
        private double riskScoreThreshold = 0.55d;
        private double contradictionTriggerThreshold = 0.60d;
        private double errorRateTriggerThreshold = 0.35d;
        private double scarcityWeight = 0.50d;
        private double contradictionWeight = 0.30d;
        private double errorRateWeight = 0.20d;
        private double starvationWeight = 0.20d;
        private double retrievalFailureWeight = 0.20d;
        private double starvationTriggerThreshold = 0.50d;
        private int maxContradictionPairs = 3;
        private boolean debugEventsEnabled = true;
        private boolean patternIdEnabled = true;
        ...
        public boolean isRiskGateEnabled() {
            return riskGateEnabled;
        }

        public void setRiskGateEnabled(boolean riskGateEnabled) {
            this.riskGateEnabled = riskGateEnabled;
        }
        ...
        public double getContradictionTriggerThreshold() {
            return contradictionTriggerThreshold;
        }

        public void setContradictionTriggerThreshold(double contradictionTriggerThreshold) {
            this.contradictionTriggerThreshold = contradictionTriggerThreshold;
        }

        public double getErrorRateTriggerThreshold() {
            return errorRateTriggerThreshold;
        }

        public void setErrorRateTriggerThreshold(double errorRateTriggerThreshold) {
            this.errorRateTriggerThreshold = errorRateTriggerThreshold;
        }

        public double getScarcityWeight() {
            return scarcityWeight;
        }

        public void setScarcityWeight(double scarcityWeight) {
            this.scarcityWeight = scarcityWeight;
        }

        public double getContradictionWeight() {
            return contradictionWeight;
        }

        public void setContradictionWeight(double contradictionWeight) {
            this.contradictionWeight = contradictionWeight;
        }

        public double getErrorRateWeight() {
            return errorRateWeight;
        }

        public void setErrorRateWeight(double errorRateWeight) {
            this.errorRateWeight = errorRateWeight;
        }
        ...
        public double getStarvationTriggerThreshold() {
            return starvationTriggerThreshold;
        }

        public void setStarvationTriggerThreshold(double starvationTriggerThreshold) {
            this.starvationTriggerThreshold = starvationTriggerThreshold;
        }

        public int getMaxContradictionPairs() {
            return maxContradictionPairs;
        }

        public void setMaxContradictionPairs(int maxContradictionPairs) {
            this.maxContradictionPairs = maxContradictionPairs;
        }
        ...
        public void setDebugEventsEnabled(boolean debugEventsEnabled) {
            this.debugEventsEnabled = debugEventsEnabled;
        }

        public boolean isPatternIdEnabled() {
            return patternIdEnabled;
        }

        public void setPatternIdEnabled(boolean patternIdEnabled) {
            this.patternIdEnabled = patternIdEnabled;
        }
    }
