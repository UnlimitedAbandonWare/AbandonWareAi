...
public class AddonsAutoConfiguration {
    ...
    @Bean(name = "addonsMatrixTransformer")
    @ConditionalOnMissingBean(MatrixTransformer.class)
    @ConditionalOnProperty(prefix = "legacy.overlay", name = "enabled", havingValue = "true")
    ...
    @Bean(name = "addonsOcrRetriever") @ConditionalOnMissingBean(OcrRetriever.class)
