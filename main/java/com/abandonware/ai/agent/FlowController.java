...
public class FlowController {
    ...
    public Map<String, Object> run(@PathVariable("flow") String flow,
        ...
        // if provided so tools like MessageSendTool can target the correct channel.
        String roomId = roomId(input == null ? null : input.get("roomId"));
    ...
    private static String roomId(Object value) {
