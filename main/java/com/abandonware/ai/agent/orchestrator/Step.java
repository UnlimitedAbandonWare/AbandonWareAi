...
public class Step {
    ...
    public void setArgs(Map<String, Object> args) { this.args = (args != null ? new HashMap<>(args) : new HashMap<>()); }
    ...
    public static class Retry {
        ...
        public void setInitialMs(long v){ this.initialMs = Math.max(0L, v); }
        public String getMode(){ return mode; }
        public void setMode(String v){
            String normalized = v == null ? "" : v.trim().toUpperCase(Locale.ROOT);
            this.mode = normalized.isBlank() ? "FIXED" : normalized;
        }
    }
}
