 ...
 * into a Channel v2.0 basicCard JSON payload. This allows the client to show
...
public class ConsentExceptionHandler {
    ...
    public ResponseEntity<String> handle(ConsentRequiredException ex, HttpServletRequest req) {
        ...
        String roomId = safe(req.getHeader("X-Channel-Room-Id"));
        ...
        String json = renderer.renderBasic(sessionId, roomId, actions, ttlSeconds);
