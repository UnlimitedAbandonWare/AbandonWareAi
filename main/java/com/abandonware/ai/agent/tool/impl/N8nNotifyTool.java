...
public class N8nNotifyTool implements AgentTool {
    ...
    public ToolResponse execute(ToolRequest request) {
        ...
        String webhookUrl = textOrNull(input.get("webhookUrl"));
        ...
        return ToolResponse.ok()
                .put("notified", true)
                .put("webhookConfigured", N8nNotifier.webhookConfigured(webhookUrl))
                .put("webhookHost", N8nNotifier.webhookHost(webhookUrl))
                .put("webhookHash", N8nNotifier.webhookHash(webhookUrl))
                .put("payloadSize", N8nNotifier.payloadSize(payload));
    }
