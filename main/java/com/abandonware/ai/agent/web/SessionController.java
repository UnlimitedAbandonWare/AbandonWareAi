...
public class SessionController {
    ...
    public ResponseEntity<Map<String,Object>> session(
        ...
        return ResponseEntity.ok(Map.of(
                "sessionIdHash", sessionId == null ? "" : com.example.lms.trace.SafeRedactor.hashValue(sessionId),
                "sessionIdLength", sessionId == null ? 0 : sessionId.length(),
                "identityHash", identity == null ? "" : com.example.lms.trace.SafeRedactor.hashValue(identity),
                "identityLength", identity == null ? 0 : identity.length(),
