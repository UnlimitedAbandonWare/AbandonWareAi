...
public class NaverSearchService {
    ...
    public List<String> searchSnippets(String query, int topK) {
        ...
        try {
            ...
            traceSuppressed("delegate.searchSnippets", e);
        }
    ...
    private static void traceSuppressed(String stage, Throwable error) {
        TraceStore.put("web.naver.adapter.suppressed", true);
        TraceStore.put("web.naver.adapter.suppressed.stage", stage);
        TraceStore.put("web.naver.adapter.suppressed.errorClass",
                error == null ? "unknown" : error.getClass().getSimpleName());
        TraceStore.inc("web.naver.adapter.suppressed.count");
    }
}
