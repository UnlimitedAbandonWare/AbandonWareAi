...
@Component("novaProtocolRuleBreakWebFilter")
public class RuleBreakInterceptor implements WebFilter {
    private static final System.Logger LOG = System.getLogger(RuleBreakInterceptor.class.getName());
    ...
    public Mono<Void> filter(ServerWebExchange exchange, WebFilterChain chain) {
        ...
        try {
            ...
            LOG.log(System.Logger.Level.DEBUG, "RuleBreak token rejected tokenLength={0} errorType={1}",
                    tok.length(), e.getClass().getSimpleName());
