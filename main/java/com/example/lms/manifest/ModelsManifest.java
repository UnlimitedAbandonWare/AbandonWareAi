...
public class ModelsManifest {
    ...
    private java.util.Map<String, Object> routing;
    ...
    public java.util.Map<String, Object> getRouting() { return routing; }
    public void setRouting(java.util.Map<String, Object> r) { this.routing = r; }
