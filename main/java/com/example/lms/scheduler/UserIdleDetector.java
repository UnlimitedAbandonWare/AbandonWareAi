...
public class UserIdleDetector {
    ...
    public boolean isIdleNow() {
        try {
            ...
            log.debug("[AutoEvolve] idle detection failed. errorHash={} errorLength={}",
    ...
    static LocalTime parseHHmm(String s, LocalTime def) {
        try {
            ...
            traceSuppressed("idleWindow.parse", e);
            return def;
        }
    }
    ...
    private static void traceSuppressed(String stage, Throwable failure) {
        ...
        com.example.lms.search.TraceStore.put("user.idle.suppressed.stage", safeStage);
        com.example.lms.search.TraceStore.put("user.idle.suppressed.errorType", safeErrorType);
        com.example.lms.search.TraceStore.put("user.idle.suppressed." + safeStage, true);
        com.example.lms.search.TraceStore.put("user.idle.suppressed." + safeStage + ".errorType", safeErrorType);
    }
}
