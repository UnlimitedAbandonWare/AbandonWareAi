...
public class VectorDlqRedriveScheduler {
    ...
    public void tick() {
        ...
        if (clearIngestProtectionOnHealthy && r.succeeded() > 0 && ingestProtectionService != null) {
            ...
            try {
                ...
                traceSuppressed("clearIngestProtection", ignore);
                // fail-soft
            }
        }
    }
    ...
    private static void traceSuppressed(String stage, Throwable failure) {
        ...
        com.example.lms.search.TraceStore.put("vector.dlq.redrive.suppressed." + safeStage, true);
        com.example.lms.search.TraceStore.put("vector.dlq.redrive.suppressed." + safeStage + ".errorType", safeErrorType);
    }
}
