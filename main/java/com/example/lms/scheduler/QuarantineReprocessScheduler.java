...
public class QuarantineReprocessScheduler {
        ...
        try {
            ...
            for (TranslationMemory tm : repo.findByLockedByAndLockedAtOrderByCreatedAtAsc(lockedBy, now)) {
                ...
                try {
                    ...
                    traceSuppressed("poisonGuard", guardErr);
                    releaseLease(tm);
                    continue;
                }
                ...
                log.info("[QUARANTINE_REPROCESS] -> PENDING idHash={} sidHash={} evidence={} len={}",
                        com.example.lms.trace.SafeRedactor.hashValue(String.valueOf(tm.getId())), com.example.lms.trace.SafeRedactor.hashValue(tm.getSessionId()), evidence, sanitized.length());
            }
        } catch (Exception e) {
            log.warn("[QUARANTINE_REPROCESS] failed errorHash={} errorLength={}",
    ...
    private void releaseLease(TranslationMemory tm) {
        ...
        try {
            ...
            traceSuppressed("releaseLease", ignore);
            // ignore
        }
    }
    ...
    private static void traceSuppressed(String stage, Throwable failure) {
        ...
        com.example.lms.search.TraceStore.put("quarantine.reprocess.suppressed." + safeStage, true);
        com.example.lms.search.TraceStore.put("quarantine.reprocess.suppressed." + safeStage + ".errorType", safeErrorType);
    }
