...
public class OnnxRerankerHealthIndicator implements HealthIndicator {
    ...
    public Health health() {
        ...
        String disabledReason = SafeRedactor.traceLabelOrFallback(svc.getDisabledReason(), "");
        if (disabledReason != null && !disabledReason.isBlank()) {
            details.put("disabledReason", disabledReason);
        }
        ...
        try {
            ...
            traceSuppressed("onnxReranker.healthValidation", t);
            validation.put("error", SafeRedactor.traceLabelOrFallback(t.getMessage(), ""));
        }
    ...
    private static void traceSuppressed(String stage, Throwable failure) {
        ...
        TraceStore.put("onnx.reranker.health.suppressed.stage", safeStage);
        TraceStore.put("onnx.reranker.health.suppressed.errorType", errorType);
        TraceStore.put("onnx.reranker.health.suppressed." + safeStage, true);
        TraceStore.put("onnx.reranker.health.suppressed." + safeStage + ".errorType", errorType);
    }
}
