...
public class OnnxHealthIndicator implements HealthIndicator {
    ...
    private static void traceSuppressed(String stage, Throwable failure) {
        ...
        TraceStore.put("onnx.health.suppressed.stage", safeStage);
        TraceStore.put("onnx.health.suppressed.errorType", errorType);
        TraceStore.put("onnx.health.suppressed." + safeStage, true);
        TraceStore.put("onnx.health.suppressed." + safeStage + ".errorType", errorType);
    }
}
