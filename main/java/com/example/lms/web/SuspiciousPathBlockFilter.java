...
public class SuspiciousPathBlockFilter extends OncePerRequestFilter {
    ...
    private static final List<String> PREFIX_BLOCKLIST = List.of(
            ...
            "/server-status", "/actuator/env", "/containers", "/containers/json"
    );

    private static final List<String> QUERY_BLOCKLIST = List.of(
            "php://input", "auto_prepend_file", "allow_url_include", "eval-stdin"
    );
