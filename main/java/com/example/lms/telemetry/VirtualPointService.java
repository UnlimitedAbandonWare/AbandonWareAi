...
public class VirtualPointService {
    ...
    public void appendNdjson(String requestId, Map<String, Object> snapshot, File file) {
        try {
            ...
            sb.append("\"requestId\":\"").append(escape(nullToEmpty(SafeRedactor.hashValue(requestId)))).append("\",");
    ...
    private static void traceSuppressed(String stage, String errorType) {
        ...
        TraceStore.put("telemetry.virtualPoint.suppressed.errorType", safeErrorType);
        TraceStore.put("telemetry.virtualPoint.suppressed." + safeStage, true);
        TraceStore.put("telemetry.virtualPoint.suppressed." + safeStage + ".errorType", safeErrorType);
    }
