...
public enum AllOpenBreakersSnapshotPolicy {
    ...
    public static final String PROP_ALL_OPEN_BREAKERS_SNAPSHOT_POLICY = "aux.blocked.allOpenSnapshot.policy";

    /** Legacy alias system property. */
    public static final String PROP_ALL_OPEN_BREAKERS_SNAPSHOT_POLICY_LEGACY = "aux.blocked.allOpenBreakersSnapshot.policy";
