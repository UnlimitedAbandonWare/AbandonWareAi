...
public final class NightmareKeys {
    ...
    /** RAG chain handler exception swallowed into fail-soft PASS */
    public static final String RAG_CHAIN_HANDLER = "rag-chain:handler";
     ...
     *
     * @param backendTag 모델명 또는 백엔드 식별자 (예: "gpt-5.5", "gemma3:27b")
    ...
    /** Web search (SerpApi) */
    public static final String WEBSEARCH_SERPAPI = "websearch:serpapi";
    /** Web search (Tavily) */
    public static final String WEBSEARCH_TAVILY = "websearch:tavily";
