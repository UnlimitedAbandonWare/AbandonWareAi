...
public record AuxCtxFlagsSnapshot(
    ...
    public Map<String, Object> toMap() {
        ...
        out.put("auxHardDown", auxHardDown);
        out.put("auxDegraded", auxDegraded);
        out.put("strikeMode", strikeMode);
        out.put("compressionMode", compressionMode);
        out.put("bypassMode", bypassMode);
        out.put("aggressivePlan", aggressivePlan);
        out.put("webRateLimited", webRateLimited);
        out.put("highRiskQuery", highRiskQuery);
        out.put("irregularityScore", irregularityScore);
        out.put("bypassReason", SafeRedactor.traceLabelOrFallback(bypassReason, "unknown"));
        return out;
    }
