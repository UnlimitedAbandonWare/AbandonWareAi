...
public class RgbMoeProperties {
    ...
    /** Add KG-enabled comparison variants to offline soak reports. */
    private boolean kgVariantEnabled = false;
    ...
    public boolean isKgVariantEnabled() {
        return kgVariantEnabled;
    }

    public void setKgVariantEnabled(boolean kgVariantEnabled) {
        this.kgVariantEnabled = kgVariantEnabled;
    }
