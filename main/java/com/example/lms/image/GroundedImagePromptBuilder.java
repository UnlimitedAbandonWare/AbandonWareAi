...
public class GroundedImagePromptBuilder {
    ...
    private String buildGroundedPrompt(String query, PromptContext ctx) {
                ...
                String web = ctx.web().stream()
                        .map(c -> {
                             try {
                                 ...
                                 traceSuppressed("imagePrompt.webSegment", ignore);
                                 return c.toString();
                             }
                         })
        ...
        if (franchiseStore != null) {
             try {
                 ...
                 traceSuppressed("imagePrompt.franchiseResolve", ignore);
             }
         }
    ...
    private static void traceSuppressed(String stage, Throwable failure) {
        ...
        TraceStore.put("image.prompt.suppressed." + safeStage, true);
        TraceStore.put("image.prompt.suppressed." + safeStage + ".errorType",
