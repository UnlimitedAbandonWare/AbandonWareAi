...
public class ArtPlateRegistry {
    ...
    public ArtPlateRegistry() {
        ...
        plates.put("AP1_AUTH_WEB", new ArtPlateSpec(
            ...
            0.35, 0.60,
            true, false, true,
            java.util.List.of(ModelCapabilities.DEFAULT_LOCAL_CHAT_MODEL, ModelCapabilities.DEFAULT_LOCAL_FAST_MODEL),
            true, 2, 1,
            0.8, 0.3, 1.0, 0.2
        ));
        ...
        plates.put("AP2_FRESH_WEB", new ArtPlateSpec(
            ...
            0.30, 0.45,
            true, false, true,
            java.util.List.of(ModelCapabilities.DEFAULT_LOCAL_CHAT_MODEL),
            true, 2, 2,
            0.5, 0.6, 0.9, 0.3
        ));
        ...
        plates.put("AP5_KG_REASON", new ArtPlateSpec(
            ...
            0.25, 0.55,
            true, false, true,
            java.util.List.of(ModelCapabilities.DEFAULT_LOCAL_JUDGE_MODEL),
            true, 2, 2,
            0.7, 0.4, 1.0, 0.7
        ));
        ...
        plates.put("AP6_LONG_POLISH", new ArtPlateSpec(
            ...
            0.20, 0.50,
            true, true, true,
            java.util.List.of(ModelCapabilities.DEFAULT_LOCAL_CHAT_MODEL, ModelCapabilities.DEFAULT_LOCAL_JUDGE_MODEL),
            true, 2, 2,
            0.6, 0.4, 0.8, 0.5
        ));

        // AP7: Safe fallback (graceful "?뺣낫 ?놁쓬" path)
        plates.put("AP7_SAFE_FALLBACK", new ArtPlateSpec(
            ...
            0.10, 0.60,
            false, false, false,
            java.util.List.of(ModelCapabilities.DEFAULT_LOCAL_FAST_MODEL),
            true, 1, 1,
            0.8, 0.2, 0.9, 0.3
        ));
        ...
        // AP10: Training RAG sparse-evidence recovery (local training data first)
        plates.put("AP10_TRAIN_RAG", new ArtPlateSpec(
            "AP10_TRAIN_RAG","rag",
            1, 14, true, false,
            600, 2100,
            java.util.List.of(),
    ...
    public Collection<ArtPlateSpec> all() {
        if (plates.isEmpty()) {
            TraceStore.put("moe.registry.empty", true);
        }
