...
public record OrchestrationSignals(
        ...
        public static OrchestrationSignals compute(String query, NightmareBreaker nb, GuardContext ctx) {
                ...
                try {
                        ...
                        traceSkipped("aux_optional_trace", ignore);
                }
                ...
                try {
                        ...
                        traceSkipped("web_rate_limited_trace", ignore);
                }
                    ...
                    try {
                        ...
                        if (stageNoiseEnabled) {
                            double max = boundedDoubleProperty(
                                            "orch.noiseGate.orch.bypassSilentFailure.escapeP.max", 0.28d,
                                            "noiseGate.max.parse");
                            double min = boundedDoubleProperty(
                                            "orch.noiseGate.orch.bypassSilentFailure.escapeP.min", 0.06d,
                                            "noiseGate.min.parse");
                            ...
                            if (noiseEscapedSilentFailure) {
                                ...
                                try {
                                    ...
                                    TraceStore.put("orch.noiseEscape.used.last", "bypassSilentFailure");
                                        ...
                                        traceSkipped("noise_escape_trace", traceError);
                                }
                            }
                        }
                    } catch (Throwable t) {
                            traceSkipped("noise_gate", t);
                    }
                }
                ...
                OrchestrationSignals signals = new OrchestrationSignals(
                                chatDown,
                                auxLlmDown,
                                auxDegraded,
                                auxHardDown,
        ...
        private static void applyExecutionPlan(GuardContext ctx, OrchestrationSignals signals) {
                try {
                        new ExecutionPlanApplier(new StrategyConflictResolver()).apply(ctx, signals);
                } catch (Throwable t) {
                        try {
                                TraceStore.put("routing.executionPlan.apply.failed", true);
                                TraceStore.put("routing.executionPlan.apply.reason", "execution_plan_apply_failed");
                                TraceStore.put("routing.executionPlan.apply.errorHash", SafeRedactor.hashValue(messageOf(t)));
                                TraceStore.put("routing.executionPlan.apply.errorLength", messageLength(t));
                        } catch (Throwable ignore) {
                                traceSkipped("execution_plan_apply_trace", ignore);
                        }
                }
        }
                        ...
                        if (truthy(TraceStore.get("dbg.search.enabled"))) {
                            try {
                                ...
                                if (n > 0 && n <= 12) {
                                    ...
                                    traceSkipped("shap_exact", e);
                            }
                        }
                } catch (Throwable t) {
                        traceSkipped("scorecard_trace", t);
                }
        }
        ...
        public void emitPartsPlanToTrace(
                ...
                try {
                        ...
                        try {
                            ...
                            traceSkipped("cfvm_pattern_trace", e);
                        }
                } catch (Throwable t) {
                        traceSkipped("parts_summary_trace", t);
                }
        }

        private static void traceSkipped(String stage, Throwable error) {
                LOG.log(System.Logger.Level.DEBUG,
                                "Orchestration signal trace skipped stage="
        ...
        private static double asDouble(Object v) {
                ...
                if (v instanceof Number n) {
                        ...
                        traceSkipped("as_double", new NumberFormatException("non_finite"));
                        return 0.0;
                }
                try {
