...
public enum RuleBreakPolicy {
    ...
    public boolean allowsTopKBoost() {
        return allowTopKBoost;
    }

    public boolean canBypassWhitelist() {
        return allowWhitelistBypass;
    }

    public boolean allowsHedgeDisable() {
        return allowHedgeDisable;
    }

    public int extraTimeoutMs() {
