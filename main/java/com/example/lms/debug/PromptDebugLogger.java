...
public class PromptDebugLogger {
    ...
    public void dumpPrompt(Object ctx, String prompt) {
        ...
        msg = truncate(msg);
        log.debug("Prompt built summary={}", SafeRedactor.diagnosticValue("prompt", msg));
    }
    ...
    public void dumpResponse(String model, String response) {
        ...
        msg = truncate(msg);
        log.debug("Response from modelHash={} modelLength={} summary={}",
                SafeRedactor.hashValue(model), lengthOf(model), SafeRedactor.diagnosticValue("response", msg));
    }
    ...
    private String truncate(String text) {
        ...
        try {
            ...
            log.debug("Prompt debug max-bytes parse skipped errorType={}", errorType(error));
        }
