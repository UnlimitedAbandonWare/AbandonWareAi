 ...
 * files will be exposed via Spring MVC.  {@code maxDownloadBytes}
 * bounds remote URL downloads before they are persisted.
 * See {@link com.example.lms.config.StaticResourceConfig} for the
 * corresponding resource handler configuration.
 */
@ConfigurationProperties(prefix = "image.storage")
public record ImageStorageProperties(String root, String publicPrefix, Long maxDownloadBytes) {
}
