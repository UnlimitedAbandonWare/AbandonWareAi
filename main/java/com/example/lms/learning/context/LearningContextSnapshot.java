...
public record LearningContextSnapshot(
    ...
    public LearningContextSnapshot {
    ...
    public static LearningContextSnapshot empty(LearningActorRole role) {
        return new LearningContextSnapshot(role, Collections.emptyList(), "", Collections.emptySet(), "");
    }

    public static LearningContextSnapshot degraded(LearningActorRole role, String reason) {
        return new LearningContextSnapshot(
                role,
    ...
    public boolean hasPersonalizedContext() {
        return actorRole != LearningActorRole.ANONYMOUS
                && (!contextSignals.isEmpty() || StringUtils.hasText(contextSummary));
    }
