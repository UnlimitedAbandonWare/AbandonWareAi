...
public class LearningWriteInterceptor {
    ...
    @Value("${abandonware.learning.min-score:${ABNADON_LEARNING_MIN_SCORE:0.75}}")
    ...
    public void ingest(String sessionId, String query, String answer, double score) {
        ...
        try {
            ...
            log.debug("Learning ingestion failed. errorHash={} errorLength={}",
        ...
        try {
            ...
            log.debug("Memory reinforcement failed. errorHash={} errorLength={}",
