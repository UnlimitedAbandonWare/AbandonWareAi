...
public class OrganizationResolver {
    ...
    private static void traceSuppressed(String stage, Throwable failure) {
        ...
        TraceStore.put("organizationResolver.suppressed.stage", safeStage);
        TraceStore.put("organizationResolver.suppressed.errorType", errorType);
        TraceStore.put("organizationResolver.suppressed." + safeStage, true);
        TraceStore.put("organizationResolver.suppressed." + safeStage + ".errorType", errorType);
    }
    ...
    public void init() {
        try {
            ...
            traceSuppressed("catalog.load", e);
