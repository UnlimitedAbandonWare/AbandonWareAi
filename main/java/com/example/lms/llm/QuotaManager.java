...
public final class QuotaManager {
    ...
    private static int getLimitForModel(String model) {
        ...
        try {
            ...
            traceSuppressed("limitParse", ignore);
            return 60;
        }
    }
    ...
    private static void traceSuppressed(String stage, Throwable failure) {
        ...
        TraceStore.put("llm.quota.suppressed." + safeStage, true);
        TraceStore.put("llm.quota.suppressed." + safeStage + ".errorType", "invalid_number");
    }
