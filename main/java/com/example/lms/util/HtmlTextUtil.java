...
public final class HtmlTextUtil {
    ...
    private static final System.Logger LOG = System.getLogger(HtmlTextUtil.class.getName());
    ...
    public static String extractAnchorText(String html) {
        ...
        try {
            ...
            traceSkipped("anchor_text", error);
        }
        return null;
    }
    ...
    public static String afterAnchor(String html) {
        ...
        try {
            ...
            traceSkipped("after_anchor", error);
        }
        return s;
    }
    ...
    private static void traceSkipped(String stage, Exception error) {
        LOG.log(System.Logger.Level.DEBUG,
                "HTML text utility parse skipped stage=" + stage + " errorType=" + errorType(error));
    }
