...
public final class ProductAliasNormalizer {
    ...
    private static final System.Logger LOG = System.getLogger(ProductAliasNormalizer.class.getName());
    ...
    private static void loadFromProperties(String resourcePath, Map<String, String> target) {
        ...
        try {
            ...
            LOG.log(System.Logger.Level.DEBUG,
                    "Product alias properties load skipped resource=" + resourcePath);
        } finally {
            if (in != null) {
                try {
                    in.close();
                    ...
                    LOG.log(System.Logger.Level.DEBUG,
                            "Product alias properties cleanup skipped stage=close_stream errorType="
