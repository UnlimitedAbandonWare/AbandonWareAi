...
public final class MetadataUtils {
    ...
    public static Map<String, Object> toMap(Metadata meta) {
        if (meta == null) {
            return Map.of();
        }
        Map<String, Object> raw = meta.toMap();
    ...
    public static Map<String, Object> toMap(Object meta) {
        if (meta == null) {
            return Map.of();
        }
        if (meta instanceof Metadata md) {
            return toMap(md);
        }
        if (meta instanceof dev.langchain4j.rag.query.Metadata md) {
            return copyMap(QueryUtils.metadata(md));
        }
