...
public class MpWhiteningConfig {
    ...
    @Bean("fullLowRankWhiteningStats")
    ...
    @Bean
    public LowRankWhiteningTransform lowRankWhiteningTransform(
            @Qualifier("fullLowRankWhiteningStats") LowRankWhiteningStats stats,
            @Value("${embedding.provider:${embed.provider:unknown}}") String embeddingProvider) {
        return new LowRankWhiteningTransform(stats, embeddingProvider);
    }

    @Bean
    public WhiteningRefitScheduler whiteningRefitScheduler(
            @Qualifier("fullLowRankWhiteningStats") LowRankWhiteningStats stats) {
