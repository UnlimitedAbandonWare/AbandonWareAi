...
import com.example.lms.service.rag.handler.AdaptiveWebStageHandler;
...
import com.example.lms.service.rag.handler.KnowledgeGraphRetrievalHandler;
...
public class RetrieverChainConfig {
    ...
    public RetrievalHandler retrievalHandler(
        ...
        var adaptiveStage = new AdaptiveWebStageHandler(adaptiveWeb);
        var h3 = new WebHandler(web, orchGate);
        var hKg = new KnowledgeGraphRetrievalHandler(kg);
