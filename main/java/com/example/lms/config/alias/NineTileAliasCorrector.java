...
private Object virtualPointService; // optional
    ...
    private String maybeRewriteWithMiniLlm(String input, java.util.Locale locale, Map<String, Object> context) {
        ...
        String thumbnailRewritePrompt = buildThumbnailPrompt(trimmed, locale, context);
        try {
            String out = lightweightNlp
                    .rewrite(thumbnailRewritePrompt)
            ...
            log.debug("NineTileAliasCorrector: mini LLM thumbnail rewrite failed, fallback to rule-based only. errorHash={} errorLength={}",
