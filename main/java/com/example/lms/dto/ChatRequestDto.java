...
public class ChatRequestDto {
        ...
        @JsonAlias({ "session_id", "conversationId", "conversation_id" })
        public void setSessionId(Object value) {
                this.sessionId = normalizeSessionId(value);
        }

        private static Long normalizeSessionId(Object value) {
                if (value == null) {
                        return null;
                }
                ...
                try {
                        ...
                        traceSuppressed("chatRequest.sessionId", ignore);
                        return null;
                }
        }
        ...
        private static void traceSuppressed(String stage, Throwable ignored) {
                ...
                TraceStore.put("chat.request.suppressed.stage", safeStage);
                TraceStore.put("chat.request.suppressed.errorType", safeErrorType);
                TraceStore.put("chat.request.suppressed." + safeStage, true);
                TraceStore.put("chat.request.suppressed." + safeStage + ".errorType", safeErrorType);
        }
        ...
        private static String errorType(Throwable ignored) {
                ...
                return ignored == null ? "unknown" : ignored.getClass().getSimpleName();
        }
        /**
        ...
        /**
         * Indicates that the client explicitly toggled the web search flag. This is
         * an intent marker only; the actual {@code useWebSearch} value may be true or
         * false and must not be coerced from this marker alone.
