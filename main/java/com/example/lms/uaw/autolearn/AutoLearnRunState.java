...
public class AutoLearnRunState {
    ...
    /** External free-tier route quota bookkeeping. */
    public String externalQuotaDay;
    public int externalQuotaCallsToday;
    public int externalQuotaOutputTokensToday;
    public long externalQuotaRateLimitUntilEpochMs;
    public String externalQuotaDisabledReason;
    ...
    public static AutoLearnRunState newDefault(String day) {
        ...
        s.externalQuotaDay = day;
        s.externalQuotaCallsToday = 0;
        s.externalQuotaOutputTokensToday = 0;
        s.externalQuotaRateLimitUntilEpochMs = 0L;
        s.externalQuotaDisabledReason = "";
        return s;
    }
}
