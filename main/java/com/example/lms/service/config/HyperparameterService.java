...
public class HyperparameterService {
    ...
    public void set(String key, double value) {
        log.info("하이퍼파라미터 동적 튜닝: keyHash={} valuePresent={} valueFinite={}",
                com.example.lms.trace.SafeRedactor.hashValue(key), true, Double.isFinite(value));
    ...
    public double getRerankSynergyWeight() {
        ...
        try {
            ...
            log.debug("[Hyperparameter] environment double fallback errorHash={} errorLength={}",
                    org.apache.commons.codec.digest.DigestUtils.sha1Hex(String.valueOf(ignored)),
                    String.valueOf(ignored).length());
            return 1.0;
        }
    }
}
