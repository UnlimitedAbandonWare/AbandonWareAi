...
public class HfInferenceEmbeddingModel implements EmbeddingModel {
    ...
    private static final System.Logger LOG = System.getLogger(HfInferenceEmbeddingModel.class.getName());
    ...
    private float[] callHf(String text) {
        ...
        try {
            ...
            LOG.log(System.Logger.Level.DEBUG, "[HfEmbedding] fail-soft stage={0}", "callHf");
            return new float[0];
        }
    }
}
