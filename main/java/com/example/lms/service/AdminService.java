...
public class AdminService {
    ...
    public Administrator getCurrentAdmin() {
        ...
        String principalText = String.valueOf(principal);
        throw new IllegalStateException("Current principal is not an Administrator principalHash="
                + com.example.lms.trace.SafeRedactor.hashValue(principalText)
                + " principalLength=" + principalText.length()
                + " principalType=" + (principal == null ? "null" : principal.getClass().getSimpleName()));
    }
    ...
    public void changePassword(String username, String newRawPassword) {
        ...
        Administrator admin = repo.findByUsername(username)
                .orElseThrow(() -> new IllegalArgumentException("Admin account not found usernameHash="
                        + com.example.lms.trace.SafeRedactor.hash12(username)
        ...
        repo.save(admin);
        log.info("admin password changed usernameHash={}", com.example.lms.trace.SafeRedactor.hash12(username));
    }
}
