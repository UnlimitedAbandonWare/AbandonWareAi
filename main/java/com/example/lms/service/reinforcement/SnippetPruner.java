...
public class SnippetPruner {
    ...
    public Result prune(String query, String snippet) {
        ...
        try {
            ...
            TraceStore.put("snippetPruner.injectionStripFallback", true);
            TraceStore.put("snippetPruner.injectionStripFallback.errorType", safeExceptionName(e));
        }
        ...
        try {
            ...
            log.warn("[Pruner] embed pruning failed. errorHash={} errorLength={}",
        ...
        if (llmPruningEnabled && chatModel != null) {
            try {
                ...
                TraceStore.put("snippetPruner.llmFallback", true);
                TraceStore.put("snippetPruner.llmFallback.errorType", safeExceptionName(e));
            }
        }
        // 3) 토큰 기반
    ...
    private static String stripHtml(String html) {
        ...
        try {
            ...
            TraceStore.put("snippetPruner.htmlStripFallback", true);
            TraceStore.put("snippetPruner.htmlStripFallback.errorType", safeExceptionName(t));
    ...
    private Result pruneByLLM(String query, String snippet) {
        ...
        String refined = chatModel
                .chat(java.util.List.of(UserMessage.from(snippetPruningPrompt)))
                .aiMessage()
                .text();
    ...
    private static String safeExceptionName(Throwable t) {
        return t == null ? "Exception" : t.getClass().getSimpleName();
    }
}
