...
public class BasicTesseractOcrService implements com.example.lms.service.ocr.OcrService {
    ...
    private static final System.Logger LOG = System.getLogger(BasicTesseractOcrService.class.getName());
    ...
    public List<OcrSpan> extract(InputStream pdfOrImage, OcrOptions opts) {
        try {
            ...
            LOG.log(System.Logger.Level.DEBUG, "[BasicTesseractOcrService] fail-soft stage={0}", "extract");
            return java.util.List.of();
        }
    }
}
