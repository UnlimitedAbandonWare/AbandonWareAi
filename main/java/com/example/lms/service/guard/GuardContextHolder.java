...
public final class GuardContextHolder {
    ...
    private static final System.Logger LOG = System.getLogger(GuardContextHolder.class.getName());
    ...
    private static boolean isWebRequestThread() {
        try {
            ...
            LOG.log(System.Logger.Level.DEBUG, "[GuardContextHolder] fail-soft stage={0}", "isWebRequestThread");
            return false;
        }
    }
