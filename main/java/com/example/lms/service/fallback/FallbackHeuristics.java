...
public final class FallbackHeuristics {
    ...
    private static final System.Logger LOG = System.getLogger(FallbackHeuristics.class.getName());
    ...
    public static Detection detect(String query) {
        ...
        try {
            ...
            LOG.log(System.Logger.Level.DEBUG, "[FallbackHeuristics] fail-soft stage={0}", "domain.classify");
