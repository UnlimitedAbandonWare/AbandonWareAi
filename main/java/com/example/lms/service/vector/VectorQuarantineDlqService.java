...
public class VectorQuarantineDlqService {
    ...
    public void recordQuarantined(
        ...
        try {
            ...
            // fail-soft
            log.warn("[VectorDLQ] recordQuarantined failed failSoft=true errorHash={} errorLength={}",
    ...
    public Map<String, Object> stats() {
        ...
        try {
            ...
            TraceStore.put("vector.quarantineDlq.suppressed.stats", true);
    ...
    public RedriveReport redriveDueOnce(String requestedBy) {
        ...
        try {
            ...
            log.warn("[VectorDLQ] claimDueLeaseTx failed errorHash={} errorLength={}",
                    com.example.lms.trace.SafeRedactor.hashValue(messageOf(e)), messageLength(e));
        ...
        for (VectorQuarantineDlq row : rows) {
            ...
            try {
                ...
                TraceStore.put("vector.quarantineDlq.suppressed.redriveBlocked", true);
                markBlocked(row, br.getMessage());
                blocked++;
            } catch (Exception e) {
                TraceStore.put("vector.quarantineDlq.suppressed.redriveRetry", true);
    ...
    private void replayOne(VectorQuarantineDlq row) {
        ...
        if (vectorSidService != null) {
            try {
                ...
                TraceStore.put("vector.quarantineDlq.suppressed.resolveSid", true);
                // fail-soft
            }
        }
    ...
    private Map<String, Object> parseMeta(String metaJson) {
        ...
        try {
            ...
            TraceStore.put("vector.quarantineDlq.suppressed.parseMeta", true);
            return new LinkedHashMap<>();
        }
    }
    ...
    private void markBlocked(VectorQuarantineDlq row, String reason) {
        ...
        row.setLastAttemptAt(LocalDateTime.now());
        row.setNextAttemptAt(null);
        row.setLastError(safeLastError(reason));
        row.setLockedAt(null);
        row.setLockedBy(null);
        repo.save(row);
    }
    ...
    private static String safeLastError(String reason) {
