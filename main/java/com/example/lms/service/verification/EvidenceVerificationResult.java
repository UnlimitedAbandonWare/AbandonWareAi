...
public class EvidenceVerificationResult {
    ...
    public EvidenceVerificationResult(int coveredEntityCount,
                                      ...
                                      boolean anyEvidence) {
        this.coveredEntityCount = nonNegative(coveredEntityCount);
        this.supportingDocCount = nonNegative(supportingDocCount);
        this.coverageScore = clampCoverage(coverageScore);
