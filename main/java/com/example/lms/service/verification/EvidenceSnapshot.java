...
public class EvidenceSnapshot {
    ...
    /**
     * Returns true if this snapshot contains any usable evidence.
     * <p>
     * Current implementation does not track individual snippet count, so the
     * presence of a non-null {@link EvidenceSnapshot} is treated as evidence
     * having been collected.
     *
     * @return true when this snapshot should be treated as having evidence
     */
