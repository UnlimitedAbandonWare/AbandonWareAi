...
public class PlanPolicyMapper {
    ...
    private static void traceGuardProfileSuppressed() {
        TraceStore.put("rag.planPolicy.suppressed.stage", "guardProfile");
        TraceStore.put("rag.planPolicy.suppressed.errorType", "IllegalArgumentException");
        TraceStore.put("rag.planPolicy.suppressed.guardProfile", true);
        TraceStore.put("rag.planPolicy.suppressed.guardProfile.reason", "unknown-profile");
        TraceStore.put("rag.planPolicy.suppressed.guardProfile.errorType", "IllegalArgumentException");
    }

    private static void traceMemoryProfileSuppressed() {
        TraceStore.put("rag.planPolicy.suppressed.stage", "memoryProfile");
        TraceStore.put("rag.planPolicy.suppressed.errorType", "unknown_profile");
        TraceStore.put("rag.planPolicy.suppressed.memoryProfile", true);
        TraceStore.put("rag.planPolicy.suppressed.memoryProfile.reason", "unknown-profile");
        TraceStore.put("rag.planPolicy.suppressed.memoryProfile.errorType", "unknown_profile");
    }
}
