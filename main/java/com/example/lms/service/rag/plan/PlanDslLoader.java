...
public class PlanDslLoader {
    ...
    private Optional<ProjectionAgentPlanSpec> loadProjectionAgentInternal(String planId) {
        ...
        try (InputStream is = res.getInputStream()) {
            ...
            log.warn("PlanDslLoader: failed to load pipeline plan planHash={} planLength={} errorHash={} errorLength={}",
                    SafeRedactor.hashValue(planId),
                    planId == null ? 0 : planId.length(),
    ...
    private static Integer intOrNull(JsonNode node, String field) {
        ...
        try {
            ...
            TraceStore.put("rag.planDsl.suppressed.intValue", true);
            TraceStore.put("rag.planDsl.suppressed.intValue.reason", "number-format");
            TraceStore.put("rag.planDsl.suppressed.intValue.errorType", "invalid_number");
            TraceStore.put("rag.planDsl.suppressed.stage", "intValue");
            TraceStore.put("rag.planDsl.suppressed.errorType", "invalid_number");
            log.debug("[AWX][plan] suppressed stage=intValue err=number-format");
            return null;
        }
    }
