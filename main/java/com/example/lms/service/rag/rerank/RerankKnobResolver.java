...
public final class RerankKnobResolver {
    ...
    private static void traceIntParseSuppressed() {
        TraceStore.put("rerank.knob.suppressed.stage", "intParse");
        TraceStore.put("rerank.knob.suppressed.errorType", "invalid_number");
        TraceStore.put("rerank.knob.suppressed.intParse", true);
        TraceStore.put("rerank.knob.suppressed.intParse.errorType", "invalid_number");
    }
