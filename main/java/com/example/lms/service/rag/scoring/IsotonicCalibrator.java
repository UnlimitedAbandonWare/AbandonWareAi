...
public class IsotonicCalibrator {
    ...
    public static IsotonicCalibrator load(File f) {
        ...
        try {
            ...
            TraceStore.put("calibration.isotonic.suppressed.stage", "load");
            TraceStore.put("calibration.isotonic.suppressed.errorType", errorType);
            TraceStore.put("calibration.isotonic.suppressed.load", true);
            TraceStore.put("calibration.isotonic.suppressed.load.errorType", errorType);
        }
        return c;
    }
