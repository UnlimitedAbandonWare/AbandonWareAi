...
public class CfvmKallocLearningProperties {
    ...
    /** Damp optimistic UCB bonus for high-value decisions. */
    private double optimismDamping = 0.35;

    /** Use Boltzmann softmax over learned arm scores after cold-start safety. */
    private boolean boltzmannEnabled = true;

    /** Boltzmann temperature; zero means deterministic best-probability arm. */
    private double boltzmannTemperature = 0.35;
    ...
    public double getOptimismDamping() {
        return optimismDamping;
    }

    public void setOptimismDamping(double optimismDamping) {
        this.optimismDamping = optimismDamping;
    }

    public boolean isBoltzmannEnabled() {
        return boltzmannEnabled;
    }

    public void setBoltzmannEnabled(boolean boltzmannEnabled) {
        this.boltzmannEnabled = boltzmannEnabled;
    }
    ...
    public void setBoltzmannTemperature(double boltzmannTemperature) {
