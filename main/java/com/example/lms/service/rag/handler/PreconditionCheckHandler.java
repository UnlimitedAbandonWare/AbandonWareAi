...
public class PreconditionCheckHandler extends AbstractRetrievalHandler {
    ...
    private static boolean mdBool(Object meta, String k, boolean defVal) {
        try {
            ...
            return defVal;
        } catch (Exception e) { RetrievalHandlerTraceSuppressions.traceSuppressed(log, "PreconditionCheckHandler", "metadata.bool", e); return defVal; }
    }
    private static String mdString(Object meta, String k, String defVal) {
        ...
        } catch (Exception e) { RetrievalHandlerTraceSuppressions.traceSuppressed(log, "PreconditionCheckHandler", "metadata.string", e); return defVal; }
    }
