...
public class SubjectResolver {
    ...
    public java.util.List<String> resolveMultipleEntities(String query) {
        ...
        try {
            ...
            String safeErrorType = SafeRedactor.traceLabelOrFallback(ignore.getClass().getSimpleName(), "unknown");
            TraceStore.put("subject.resolver.suppressed.stage", "entityScan");
            TraceStore.put("subject.resolver.suppressed.errorType", safeErrorType);
            TraceStore.put("subject.resolver.suppressed.entityScan", true);
            TraceStore.put("subject.resolver.suppressed.entityScan.errorType", safeErrorType);
