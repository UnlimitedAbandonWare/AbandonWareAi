...
public class NovaOrchestrationProperties {
    ...
    public static class DegradedStorageProps {
        ...
        /**
         * If an item has been claimed/inflight longer than this, it will be recovered back to
         * pending on a sweep.
         */
        ...
        /**
         * If enabled, items that exceed {@link #maxAttempts} will be quarantined instead of being
         ...
         *
         * <p>0 or negative disables the quarantine behavior.</p>
         */
