...
public class ConversationBreadcrumbAspect {
    ...
    @Around("execution(* com.example.lms.service.ChatWorkflow.continueChat(..)) && args(req,..)")
    public Object aroundContinueChat(ProceedingJoinPoint pjp, ChatRequestDto req) throws Throwable {
