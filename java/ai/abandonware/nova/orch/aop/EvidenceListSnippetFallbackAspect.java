...
public class EvidenceListSnippetFallbackAspect {
     ...
     */
    @Around("execution(public String com.example.lms.service.rag.EvidenceAnswerComposer.compose(..)) && args(question, evidence, lowRisk)")
    public Object aroundEvidenceAnswerComposer(ProceedingJoinPoint pjp,
                                              String question,
                                              List<EvidenceAwareGuard.EvidenceDoc> evidence,
                                              boolean lowRisk) throws Throwable {
        if (!enabled()) {
            return pjp.proceed();
        }
        ...
        return pjp.proceed(new Object[]{question, out, lowRisk});
    }
