...
public class OptionalIrregularityCapAspect {
    ...
    @Around("execution(void com.example.lms.infra.resilience.IrregularityProfiler.bump(..)) && args(ctx, delta, reason)")
    public Object aroundBump(ProceedingJoinPoint pjp, GuardContext ctx, double delta, String reason) throws Throwable {
        ...
        Object out = pjp.proceed(new Object[]{ctx, effective, reason});
