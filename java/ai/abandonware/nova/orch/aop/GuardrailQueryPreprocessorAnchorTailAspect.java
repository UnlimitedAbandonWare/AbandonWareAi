...
public class GuardrailQueryPreprocessorAnchorTailAspect {
    ...
    @Around("execution(String com.example.lms.service.rag.pre.GuardrailQueryPreprocessor.enrich(..)) && args(original)")
    public Object aroundEnrich(ProceedingJoinPoint pjp, String original) throws Throwable {
