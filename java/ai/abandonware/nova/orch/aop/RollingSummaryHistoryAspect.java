...
public class RollingSummaryHistoryAspect {
    ...
    @Around("execution(* com.example.lms.service.ChatHistoryService.getFormattedRecentHistory(..)) && args(sessionId, limit)")
    @SuppressWarnings("unchecked")
    public Object aroundGetFormattedRecentHistory(ProceedingJoinPoint pjp, Long sessionId, int limit) throws Throwable {
