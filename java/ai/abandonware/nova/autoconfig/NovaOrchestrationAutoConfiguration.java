...
@EnableConfigurationProperties({ NovaOrchestrationProperties.class, LlmRouterProperties.class,
        NovaWebFailSoftProperties.class, NovaBraveAdaptiveQpsProperties.class,
...
public class NovaOrchestrationAutoConfiguration {
    ...
    public BraveAdaptiveQpsInstaller braveAdaptiveQpsInstaller(NovaBraveAdaptiveQpsProperties props) {
        return new BraveAdaptiveQpsInstaller(props);
    }
