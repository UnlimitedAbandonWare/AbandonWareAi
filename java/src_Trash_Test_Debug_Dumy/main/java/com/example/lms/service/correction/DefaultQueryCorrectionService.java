...
import com.example.lms.service.correction.KoreanPreprocessor;
...
public class DefaultQueryCorrectionService implements QueryCorrectionService {
    ...
    public String correct(String input) {
        ...
        String s = input;
        // Korean‑first preprocessing
        String ks = KoreanPreprocessor.preprocess(s);
        if (ks != null && !KoreanPreprocessor.minorChange(s, ks)) {
            s = ks;
        }
