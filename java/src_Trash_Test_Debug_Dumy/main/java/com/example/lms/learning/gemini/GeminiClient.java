...
public class GeminiClient {
    ...
    /**
     * API key for the Gemini image endpoints.  This value must be supplied
     * via configuration (e.g. {@code application.yml}) under the
     * {@code gemini.api.key} property.  Environment variables and other
     * fallback mechanisms are deliberately not used to load secrets.  If
     * backwards compatibility with the legacy {@code gemini.api-key}
     * property is required, define both keys in your configuration file.
     */
