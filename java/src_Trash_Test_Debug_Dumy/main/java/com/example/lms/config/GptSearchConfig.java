...
public class GptSearchConfig {
    ...
    public AdaptiveWebSearchHandler adaptiveWebSearchHandler(
            ...
            com.example.lms.gptsearch.web.FanoutQuorumSearchService searchFanout,
        ...
        return new AdaptiveWebSearchHandler(decisionService, searchFanout, scraper, relevanceScoringService, domainProfileLoader);
    }
}