    ...
    SecurityFilterChain adminSecurity(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .formLogin(form -> form
                        ...
                        .permitAll())
                // Use a stable key for remember-me cookies instead of an ellipsis placeholder
                .rememberMe(rem -> rem.key("remember-me-key").tokenValiditySeconds(86400).alwaysRemember(true))
