...
public class SmartQueryPlanner {
    ...
    public List<String> plan(String userPrompt, @Nullable String assistantDraft, int maxQueries) {
        ...
        if (selector != null) {
            try {
                ...
                org.slf4j.LoggerFactory.getLogger(getClass()).warn("[SmartQueryPlanner] LLM keyword selection failed; falling back", e);
            }
        }
    ...
    // private static String ensureSubjectAnchor(String q, String primary, String alias) { /* removed */ }
}