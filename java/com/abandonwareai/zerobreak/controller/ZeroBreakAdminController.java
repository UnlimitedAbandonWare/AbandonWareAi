...
public class ZeroBreakAdminController {
    ...
    public Map<String,Object> dryRun(@RequestBody Map<String,Object> payload) {
        ...
        // k와 x0는 현재 FinalSigmoidGate 구현에서 사용되지 않으므로 보존만 하고 사용하지 않습니다.
        ...
        // 생성자 시그니처: (double threshold, String guardMode)
        FinalSigmoidGate sg = new FinalSigmoidGate(0.90, "aggressive");
        // 메서드 이름: approve(...) → allow(...)
        boolean approved = citesOk && sg.allow(fuseScore);
