...
/**
 * DPP L-ensemble greedy reranker (log-det gains via Schur complement).
 * Inputs: relevance r_i in [0,1], embeddings X (n x d).
 * Kernel L = D^alpha * (X X^T) * D^alpha  (alpha in [0,1])
 */
