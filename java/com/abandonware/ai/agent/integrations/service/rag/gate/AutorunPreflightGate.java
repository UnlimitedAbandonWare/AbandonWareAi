...
/** Minimal, dependency-free Autorun Preflight Gate.
 *  Evaluates evidence count and authority-tier ratio, with an optional risk score.
 *  Toggle via application.yml: autorun.preflight.enabled
 */
