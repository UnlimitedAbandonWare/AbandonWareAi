...
import com.example.rag.fusion.calib.IsotonicCalibrator;
import com.example.rag.fusion.calib.ScoreCalibrator;
/**
...
public final class FusionCalibrator {
    ...
    /**
     * shim for an isotonic regression calibrator.  The current
    ...
    public static double[] isotonic(double[] values) {
        // shim: implement isotonic regression calibration; currently falls back to default behavior.
        // to min-max scaling.
