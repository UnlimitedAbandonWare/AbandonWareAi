...
/**
 * A stub retrieval handler that checks whether a query appears to be a
 ...
 * currently does not perform any enrichment and serves as a placeholder
...
public class LocationAwareHandler extends AbstractRetrievalHandler {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(LocationAwareHandler.class);
