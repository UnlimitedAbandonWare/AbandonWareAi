...
public class QueryHygieneUtil {
    ...
    public String clean(String q) {
        ...
        /**
     * Produce a small set of query variants from the cleaned form.
     * This utility now returns only the cleaned query itself; richer
     * expansion is delegated to higher-level alias/rewriter components.
     *
    ...
    public List<String> expandVariants(String cleaned) {
        ...
        // Legacy special-casing for specific company names has been removed.
        // Variant generation is now handled by alias dictionaries / vector alias correctors.
        out.add(cleaned);
        return out;
    }
    ...
    public static boolean looksLikeCorp(String q) {
        ...
        return q.contains("주식") || q.contains("㈜") || q.toLowerCase().contains("inc");
    }
}