...
public class ChatWorkflow {
    ...
    public ChatResult continueChat(ChatRequestDto req,
        ...
        if (useWeb) {
            ...
            // - When web is effectively hard-down (both engines skipped / hybrid breaker open),
            //   disable the web stage for this request (fail-soft: rely on vector / other).
            // - Also disable web-dependent Analyze/SelfAsk so we don't spin on empty web merges.
            ...
            if (useWeb && (fused == null || fused.isEmpty()) && hints != null && hints.isAllowWeb() && !webHardDownNow) {
                try {
