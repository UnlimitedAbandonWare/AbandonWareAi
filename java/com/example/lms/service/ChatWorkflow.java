    ...
    public ChatResult continueChat(ChatRequestDto req,
        ...
        if (useWeb) {
            ...
            if (futureTech && latestTechAutoDisableVector) {
                ...
                planned = smartQueryPlanner.plan(finalQuery, /* assistantDraft */ null, /* maxBranches */ maxBranches);
            ...
            if (useWeb && (fused == null || fused.isEmpty())) {
                try {
                    ...
                    List<dev.langchain4j.rag.content.Content> webOnly = webSearchRetriever
                            .retrieve(QueryUtils.buildQuery(finalQuery, sessionIdLong, null, metaHints));
        ...
        for (int attempt = 0; attempt <= llmMaxAttempts; attempt++) {
            try {
                ...
                if (evidencePresent && llmFastBailoutOnTimeoutWithEvidence && isTimeout) {
                    ...
                    throw new RuntimeException("LLM timeout fast-bail (evidence present)", e);
                }
