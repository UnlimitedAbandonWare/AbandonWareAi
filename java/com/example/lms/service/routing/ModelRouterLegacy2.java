...
/**
 * @deprecated 새로운 ModelRouter / PromptBuilder 기반 구조로 대체됨.
 *             HybridEngineArbiter / MatrixPolicyEngine / PromptOrchestrator 사용 권장.
    ...
    private ChatModel createModel(String modelName) {
        try {
            ...
            throw new IllegalStateException(
                    "Failed to create ChatModel for name=" + modelName, e
            );
        }
    }
