 ...
 * Legacy transformer.
 *
 * <p>This project now prefers the core {@link QueryTransformer} implementation wired with the
 * fast/utility LLM for strict time-boxing.
 *
 * <p>To avoid accidental double-registration (and ambiguous injection), this legacy transformer
 * is disabled by default and can be enabled only when explicitly requested.
 */
@Component
@ConditionalOnProperty(name = "legacy.default-query-transformer.enabled", havingValue = "true")
