    ...
    private String cachedLlm(String prompt) {
        ...
        if (bd.bypass()) {
            ...
            try {
                ...
                AuxBlockTracker.markStageBlocked("queryTransformer", reason,
                        "QueryTransformer.cachedLlm(" + bd.trigger() + ")",
                ...
                TraceStore.putIfAbsent("aux.queryTransformer.blocked.trigger", bd.trigger());
            ...
            try {
                ...
                emitQtx(
                        ...
                        "qtx.bypass",
                        "QueryTransformer bypass (no aux LLM call)",
            ...
            try {
                ...
                CompletableFuture.runAsync(ContextPropagation.wrap(() -> {
                    ...
                    if (nightmareBreaker != null) {
                        nightmareBreaker.recordTimeout(NightmareKeys.QUERY_TRANSFORMER_RUN_LLM, "cachedLlm",
                                "force-kill");
                    }
                    created.complete("");
