...
public class ArtPlateRegistry {
    ...
    public ArtPlateRegistry() {
        ...
        plates.put("AP1_AUTH_WEB", new ArtPlateSpec(
            ...
            0.35, 0.60,
            true, false, true,
            java.util.List.of("qwen2.5-7b-instruct","llama-3.1-8b-instruct"),
            true, 2, 1,
            0.8, 0.3, 1.0, 0.2
        ));
        ...
        plates.put("AP2_FRESH_WEB", new ArtPlateSpec(
            ...
            0.30, 0.45,
            true, false, true,
            java.util.List.of("qwen2.5-7b-instruct"),
            true, 2, 2,
            0.5, 0.6, 0.9, 0.3
        ));
        ...
        plates.put("AP6_LONG_POLISH", new ArtPlateSpec(
            ...
            0.20, 0.50,
            true, true, true,
            java.util.List.of("qwen2.5-7b-instruct","qwen2.5-7b-instruct"),
            true, 2, 2,
            0.6, 0.4, 0.8, 0.5
        ));
