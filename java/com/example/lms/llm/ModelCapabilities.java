...
public final class ModelCapabilities {
    ...
    private static final Set<String> RIGID_TEMPERATURE_MODELS = Set.of("qwen2.5-7b-instruct");
    private ModelCapabilities() {}

    public static boolean requiresDefaultTemperature(String modelId) {
        if (modelId == null) return false;
        String m = modelId.trim().toLowerCase();
        return RIGID_TEMPERATURE_MODELS.contains(m) || m.contains("qwen2.5-7b-instruct");
    }
    /** 모델이 rigid면 1.0으로 강제 */
