 ...
 *
 * <p>Policy: if multiple sources are set (even if equal), fail-fast so runtime
 * does not silently pick an arbitrary key source.</p>
 */
@Component
public class KeyResolver {
     ...
     *
     * <p>Sources: llm.api-key OR LLM_API_KEY</p>
     */
     ...
     *
     * <p>Sources: gemini.api-key OR gemini.api.key (compat) OR GEMINI_API_KEY</p>
     */
