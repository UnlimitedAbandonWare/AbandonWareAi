 ...
 * Module: com.abandonware.ai.guard.AnswerSanitizer
 * Role: config
 * Feature Flags: whitelist
 * Dependencies: com.abandonware.ai.service.rag.auth.DomainProfileLoader
 * Observability: propagates trace headers if present.
 * Thread-Safety: unknown.
 */
/* agent-hint:
id: com.abandonware.ai.guard.AnswerSanitizer
role: config
flags: [whitelist]
*/
