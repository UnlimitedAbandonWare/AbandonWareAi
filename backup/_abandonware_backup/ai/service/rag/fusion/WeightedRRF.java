...
\1
import com.abandonware.ai.service.rag.fusion.RerankCanonicalizer;
 ...
 * Module: com.abandonware.ai.service.rag.fusion.WeightedRRF
 * Role: config
 * Feature Flags: kg
 * Dependencies: com.abandonware.ai.service.rag.model.ContextSlice, com.abandonware.ai.ml.SoftmaxUtils, com.abandonware.ai.service.rag.fusion.ScoreCalibrator
 * Observability: propagates trace headers if present.
 * Thread-Safety: unknown.
 */
/* agent-hint:
id: com.abandonware.ai.service.rag.fusion.WeightedRRF
role: config
flags: [kg]
*/
...
// auto-patch: integrate canonicalization & calibration
private transient ScoreCalibrator __calib = new ScoreCalibrator();
private String __canon(String url) { return RerankCanonicalizer.url(url); }