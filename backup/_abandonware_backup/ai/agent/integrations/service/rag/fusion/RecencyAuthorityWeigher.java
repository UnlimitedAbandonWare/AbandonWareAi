 ...
 * Module: com.abandonware.ai.agent.integrations.service.rag.fusion.RecencyAuthorityWeigher
 * Role: config
 * Observability: propagates trace headers if present.
 * Thread-Safety: appears stateless.
 */
/* agent-hint:
id: com.abandonware.ai.agent.integrations.service.rag.fusion.RecencyAuthorityWeigher
role: config
*/
