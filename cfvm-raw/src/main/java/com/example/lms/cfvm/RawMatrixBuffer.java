 ...
 * 클래스: RawMatrixBuffer
 * 역할(Role): Class
 * 소스 경로: cfvm-raw/src/main/java/com/example/lms/cfvm/RawMatrixBuffer.java
 *
 * 연결 포인트(Hooks):
...
// Module: com.example.lms.cfvm.RawMatrixBuffer
// Role: config
// Observability: propagates trace headers if present.
// Thread-Safety: uses concurrent primitives.
// /
/* agent-hint:
id: com.example.lms.cfvm.RawMatrixBuffer
role: config
*/
