...
public class SettingsController {
    ...
    public ResponseEntity<Map<String, String>> saveAllSettings(@RequestBody Map<String, String> settingsToSave) {
        ...
        return ResponseEntity.ok(Map.of("message", "설정이 성공적으로 저장되었습니다."));
    }
}