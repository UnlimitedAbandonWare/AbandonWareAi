 ...
 * Module: com.abandonware.ai.example.lms.cfvm.CfvmRawService
 * Role: service
 * Dependencies: com.github.benmanes.caffeine.cache.Cache, com.github.benmanes.caffeine.cache.Caffeine
 * Observability: propagates trace headers if present.
 * Thread-Safety: appears stateless.
 */
/* agent-hint:
id: com.abandonware.ai.example.lms.cfvm.CfvmRawService
role: service
*/
