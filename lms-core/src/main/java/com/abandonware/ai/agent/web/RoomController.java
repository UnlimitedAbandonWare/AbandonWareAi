 ...
 * Module: com.abandonware.ai.agent.web.RoomController
 * Role: controller
 * Key Endpoints: GET /api/rooms, POST /api/rooms, ANY /api/api
 * Dependencies: com.abandonware.ai.agent.context.ContextBridge, com.abandonware.ai.agent.identity.IdentityUtils, com.abandonware.ai.agent.room.Room, +1 more
 * Observability: propagates trace headers if present.
 * Thread-Safety: appears stateless.
 */
/* agent-hint:
id: com.abandonware.ai.agent.web.RoomController
role: controller
api:
  - GET /api/rooms
  - POST /api/rooms
