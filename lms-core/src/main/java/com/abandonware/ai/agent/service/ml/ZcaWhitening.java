 ...
 * 클래스: ZcaWhitening
 * 역할(Role): Class
 * 소스 경로: lms-core/src/main/java/com/abandonware/ai/agent/service/ml/ZcaWhitening.java
 *
 * 연결 포인트(Hooks):
...
// Module: com.abandonware.ai.agent.service.ml.ZcaWhitening
// Role: config
// Observability: propagates trace headers if present.
// Thread-Safety: appears stateless.
// /
/* agent-hint:
id: com.abandonware.ai.agent.service.ml.ZcaWhitening
role: config
*/
class ZcaWhitening {
