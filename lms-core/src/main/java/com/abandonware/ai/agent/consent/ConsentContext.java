 ...
 * 클래스: ConsentContext
 * 역할(Role): Class
 * 소스 경로: lms-core/src/main/java/com/abandonware/ai/agent/consent/ConsentContext.java
 *
 * 연결 포인트(Hooks):
...
// Module: com.abandonware.ai.agent.consent.ConsentContext
// Role: config
// Feature Flags: sse
...
// /
/* agent-hint:
id: com.abandonware.ai.agent.consent.ConsentContext
role: config
flags: [sse]
*/
