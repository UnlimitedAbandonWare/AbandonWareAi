 ...
 * 소스 경로: lms-core/src/main/java/com/abandonware/ai/trace/TraceHeaders.java
 *
 * 연결 포인트(Hooks):
...
// Module: com.abandonware.ai.trace.TraceHeaders
// Role: config
// Observability: propagates trace headers if present.
// Thread-Safety: appears stateless.
// /
/* agent-hint:
id: com.abandonware.ai.trace.TraceHeaders
role: config
*/
class TraceHeaders {
