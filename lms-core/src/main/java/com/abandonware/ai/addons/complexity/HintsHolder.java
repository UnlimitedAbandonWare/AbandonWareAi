 ...
 * 클래스: HintsHolder
 * 역할(Role): Class
 * 소스 경로: lms-core/src/main/java/com/abandonware/ai/addons/complexity/HintsHolder.java
 *
 * 연결 포인트(Hooks):
...
// Module: com.abandonware.ai.addons.complexity.HintsHolder
// Role: config
// Observability: propagates trace headers if present.
// Thread-Safety: appears stateless.
// /
/* agent-hint:
id: com.abandonware.ai.addons.complexity.HintsHolder
role: config
*/
class HintsHolder {
