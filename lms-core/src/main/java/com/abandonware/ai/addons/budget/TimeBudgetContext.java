 ...
 * 클래스: TimeBudgetContext
 * 역할(Role): Class
 * 소스 경로: lms-core/src/main/java/com/abandonware/ai/addons/budget/TimeBudgetContext.java
 *
 * 연결 포인트(Hooks):
...
// Module: com.abandonware.ai.addons.budget.TimeBudgetContext
// Role: config
// Observability: propagates trace headers if present.
// Thread-Safety: appears stateless.
// /
/* agent-hint:
id: com.abandonware.ai.addons.budget.TimeBudgetContext
role: config
*/
class TimeBudgetContext {
