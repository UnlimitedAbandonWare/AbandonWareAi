 ...
 * 클래스: TimeBudget
 * 역할(Role): Class
 * 소스 경로: lms-core/src/main/java/com/abandonware/ai/addons/budget/TimeBudget.java
 *
 * 연결 포인트(Hooks):
...
// Module: com.abandonware.ai.addons.budget.TimeBudget
// Role: config
// Observability: propagates trace headers if present.
// Thread-Safety: appears stateless.
// /
/* agent-hint:
id: com.abandonware.ai.addons.budget.TimeBudget
role: config
*/
class TimeBudget {
