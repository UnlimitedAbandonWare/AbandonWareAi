 ...
 * Module: com.abandonware.ai.vector.FederatedEmbeddingStore
 * Role: config
 * Feature Flags: retrieval.vector.enabled
 * Observability: propagates trace headers if present.
 * Thread-Safety: unknown.
 */
/* agent-hint:
id: com.abandonware.ai.vector.FederatedEmbeddingStore
role: config
flags: [retrieval.vector.enabled]
*/
