 ...
 * 클래스: IdentityWhitening
 * 역할(Role): Class
 * 소스 경로: lms-core/src/main/java/com/abandonware/ai/service/rag/whiten/IdentityWhitening.java
 *
 * 연결 포인트(Hooks):
...
// Module: com.abandonware.ai.service.rag.whiten.IdentityWhitening
// Role: config
// Observability: propagates trace headers if present.
// Thread-Safety: appears stateless.
// /
/* agent-hint:
id: com.abandonware.ai.service.rag.whiten.IdentityWhitening
role: config
*/
class IdentityWhitening implements Whitening {
