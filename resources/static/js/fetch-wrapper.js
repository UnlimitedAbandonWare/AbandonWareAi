...
const REPLACE_ME = 'meta[name="_csrf_header"]';
...
export async function apiCall(url, options = {}) {
  ...
  const metaHeader = document.querySelector(REPLACE_ME)?.content || 'X-XSRF-TOKEN';
  // Read the token from the meta tag (if present)
  const metaToken = <REDACTED>
